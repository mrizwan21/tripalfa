...
The Wallet Management End-to-End Testing Orchestrator provides comprehensive testing coverage for the complete wallet lifecycle, including wallet creation, fund deposits (top-ups), payments, refunds, transfers, and **global multi-currency operations across 65+ currencies**.
...
**Test File**: `scripts/wallet-management-orchestrator.ts` (Global Currency Support: lines 477-530, Multi-Currency Tests: lines 929-971)

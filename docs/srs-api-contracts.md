...
This file contains detailed request/response JSON schemas for the booking-engine frontend to call backend endpoints described in the SRS. Use these as authoritative contracts for frontend stubs and backend implementation.
...
// json
{
  ...
  "definitions": {
    ...
    "Money": {"type":"object","properties":{"amount":{"type":"number"},"currency":{"type":"string"}},"required":["amount","currency"]}
  }
}
```
...
// json
{
  ...
  "properties":{
    ...
    "status":{"type":"string"},
    "reference":{"type":"string"},
    "total":{"type":"object","properties":{"amount":{"type":"number"},"currency":{"type":"string"}},"required":["amount","currency"]},
    "createdAt":{"type":"string","format":"date-time"},
...
// json
{
  ...
  "properties":{
    ...
    "latitude":{"type":"number"},
    "longitude":{"type":"number"},
    "images":{"type":"array","items":{"type":"object","properties":{"url":{"type":"string"},"hero":{"type":"boolean"},"maxwidth":{"type":"integer"}}}},
    "facilities":{"type":"array","items":{"type":"object","properties":{"code":{"type":"string"},"name":{"type":"string"},"free":{"type":"boolean"}}}},
    "rooms":{"type":"array","items":{
      ...
      "properties":{
        ...
        "originalPrice":{"type":"object","properties":{"amount":{"type":"number"},"currency":{"type":"string"}}},
        "tax":{"type":"number"},
        "commission":{"type":"number"},
...
// json
{
  ...
  "properties":{
    "hotelId":{"type":"string"},
    "rooms":{"type":"array","items":{"type":"object","properties":{"roomTypeId":{"type":"string"},"quantity":{"type":"integer","minimum":1}}}},
    "checkin":{"type":"string","format":"date"},
    "checkout":{"type":"string","format":"date"},
...
// json
{
  ...
  "properties":{
    ...
    "total":{"type":"object","properties":{"amount":{"type":"number"},"currency":{"type":"string"}}}
  },
...
```json
// json
{ "from":"string","to":"string","departDate":"date","returnDate":"date?","cabin":"string","pax":{"adults":1,"children":0,"infants":0} }
```
...
// json
{
  "amount":123.45,
  "currency":"USD",
  "card":{ "number":"4111111111111111","expiry":"12/26","cvv":"123","holderName":"Alice" },
  "metadata":{}
}
```
...
```json
// json
{ "success":true, "transactionId":"TXN-123456", "authorization":{"provider":"stripe","id":"auth_..."} }
```
...
```json
// json
{ "amount":100,"currency":"USD","walletAccount":"WAL-USD-1","userId":"u_123" }
```
...
```json
// json
{ "accountFrom":"STRIPE-USD","accountTo":"WAL-USD","amount":500,"currency":"USD","paymentType":"card" }
```

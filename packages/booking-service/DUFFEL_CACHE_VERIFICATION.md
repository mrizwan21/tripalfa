...
- **Status**: Managed through shared migration workflow
- **Contains**:
  - DDL for cache tables with JSONB data columns
...
**File**: [packages/booking-service/src/services/duffel-api-manager.service.ts](./src/services/duffel-api-manager.service.ts)
...
**File**: [packages/booking-service/src/routes/duffel.ts](./src/routes/duffel.ts)

...
- **File**: [packages/booking-service/src/middleware/duffel-hybrid-cache.service.ts](./src/middleware/duffel-hybrid-cache.service.ts)
...
- **File**: [packages/shared-database/prisma/schema.prisma](../shared-database/prisma/schema.prisma)
...
- **Path**: `packages/shared-database/prisma/migrations/*` (Prisma-managed migration history)
- **Creates**: All necessary PostgreSQL tables with proper indexing
- **Status**: Applied through shared Prisma migration workflow

### 4. **Middleware Integration** ✅

- **File**: [packages/booking-service/src/middleware/duffel-cache.middleware.ts](./src/middleware/duffel-cache.middleware.ts)
- **Already Using Service**: Routes file imports and uses all middleware functions
- **Location**: [packages/booking-service/src/routes/duffel.ts](./src/routes/duffel.ts)
...
- Ensure shared Prisma migrations are applied from `packages/shared-database/prisma/migrations/*`
- Check Prisma models are generated: `pnpm run db:generate`
...
| Shared Prisma migration set     | ✅ Managed       | workspace-owned |

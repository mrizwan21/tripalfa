...
const SelectGroup = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Group> & { className?: string; children?: React.ReactNode }
>(({ className, ...props }, ref) => (
...
const SelectContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content> & { className?: string; children?: React.ReactNode; position?: "popper" | "item-aligned" }
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-1.5 pl-8 pr-2 text-xs font-semibold uppercase tracking-wide text-slate-400", className)}
    {...props as any}
  />
))
...
const SelectItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & { value: string | number; className?: string; children?: React.ReactNode }

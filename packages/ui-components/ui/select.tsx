...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Group ref={ref} className={className} {...(props as any)} />
));
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <SelectPrimitive.Icon asChild {...(props as any)}>
...
>(({ className, children, position = "popper" as const, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-lg border border-slate-200 bg-white text-slate-700 shadow-soft",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-xs font-semibold uppercase tracking-wide text-slate-400",
      className,
    )}
    {...(props as any)}
  />

...
function validateCountryData(country) {
    ...
    if (country.numericCode && (isNaN(country.numericCode) || country.numericCode < 1 || country.numericCode > 999)) {
...
function generateReport() {
    ...
    console.log(`Success Rate: ${((stats.processedCountries - stats.errors) / stats.processedCountries * 100).toFixed(1)}%`);
    ...
    if (stats.errors === 0) {
        ...
        console.log(`⚠️  Countries import completed with ${stats.errors} errors. Check logs above for details.`);
    }
}

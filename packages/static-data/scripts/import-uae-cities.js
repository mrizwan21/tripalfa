...
function generateReport() {
    ...
    console.log(`Success Rate: ${((stats.processedCities - stats.errors) / stats.processedCities * 100).toFixed(1)}%`);
    ...
    if (stats.errors === 0) {
        ...
        console.log(`⚠️  Cities import completed with ${stats.errors} errors. Check logs above for details.`);
    }
}

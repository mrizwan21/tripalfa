/**
 * Centralized notification types and mock data
 */

import { NotificationType, NotificationStatus, NotificationItem } from '../types';

// Notification types (already defined in types.ts)
...
// Centralized mock notifications data
...
export const getMockNotifications = (): NotificationItem[] => MOCK_NOTIFICATIONS;
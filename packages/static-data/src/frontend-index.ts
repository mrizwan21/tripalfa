  ...
  CABINS: {
    all: [
      ...
      },
      {
        ...
        description: "Enhanced economy with extra legroom",
      },
      {
        code: "business",
        name: "Business",
...
export const HOTEL_STATIC_DATA = {
  ...
  BOARD_TYPES: {
    all: [
      ...
      {
        code: "BBR",
        name: "Bed & Breakfast + Refreshments",
        description: "Breakfast and select beverages included",
      },
    ],
  },
    ...
    all: [
      {
        code: "HOTEL",
        name: "Hotel",
        description: "Traditional hotel property",
      },
      {
        code: "RESORT",
        name: "Resort",
      ...
      },
      {
        code: "VILLA",
        name: "Villa",
        description: "Private villa accommodation",
      },
      {
        code: "HOSTEL",
        name: "Hostel",
      ...
      },
      {
        code: "GUESTHOUSE",
        name: "Guesthouse",
        description: "Small lodging property",
      },
      { code: "MOTEL", name: "Motel", description: "Roadside lodging" },
      {
        code: "LODGE",
        name: "Lodge",
        description: "Nature-focused accommodation",
      },
    ],
  },
  ...
  ROOM_TYPES: {
    all: [
      ...
      },
      {
        code: "FAMILY",
        name: "Family Room",
        description: "Room for families with children",
      },
      {
        code: "STUDIO",
        name: "Studio",
      ...
      },
      {
        code: "DELUXE",
        name: "Deluxe Room",
        description: "Upgraded room with extra amenities",
      },
      {
        code: "EXECUTIVE",
        name: "Executive Room",
        description: "Business-oriented room",
      },
    ],
  },
  ...
  POPULAR_DESTINATIONS: [
    ...
    },
    {
      ...
      hotelCount: 580,
      imageUrl:
        "https://images.unsplash.com/photo-1586724237569-f3d0c1dee8c6?auto=format&fit=crop&q=80",
    },
    {
      id: "4",
      name: "Jeddah",
      ...
      hotelCount: 340,
      imageUrl:
        "https://images.unsplash.com/photo-1564769625673-cb560fa24828?auto=format&fit=crop&q=80",
    },
    {
      id: "5",
      name: "Doha",

  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">Rules Engine</h1>
          <p className="text-muted-foreground">Manage pricing, markup, and commission rules</p>
        </div>
        <Button
          variant="outline"
          size="default"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0 gap-4">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-lg font-bold text-foreground truncate">{rule.name}</h3>
                      <span
                    ...
                    <div className="flex gap-6 mt-3 text-xs text-muted-foreground">
                      ...
                      <span>
                        Updated:{' '}
                        <span className="font-semibold text-foreground">{rule.lastModified}</span>
                      </span>
                    </div>
                  </div>
                ...
                <div className="border-t border-border p-4 bg-muted/50">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-foreground mt-1">#{rule.priority}</p>
                    </div>
                  </div>

      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">{airline?.program || 'Loyalty Program'}</p>
          </div>
        </div>
        <Button
          variant="outline"
    ...
    <div className="space-y-4">
      ...
      <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-100">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-indigo-900">Corporate Loyalty Benefits</p>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="max-h-48 overflow-y-auto border border-border rounded-lg mt-2">
                {filteredAirlines.map(airline => (
                  ...
                  >
                    <div>
                      <p className="text-sm font-medium text-foreground">{airline.name}</p>
                      <p className="text-xs text-muted-foreground">{airline.program}</p>
                    </div>
                    <Badge variant="secondary" className="text-xs">
                      {airline.code}
                    </Badge>
            ...
            <DialogFooter className="gap-2 sm:gap-0">
              ...
              <Button type="submit" disabled={submitting} size="sm" className="hover:">
                {submitting ? (
                  <Loader2 className="h-4 w-4 animate-spin" />
                ) : (
                  <>

...
const AlertBox = ({
  ...
  const icons = {
    success: <CheckCircle2 className="h-5 w-5 text-emerald-600 flex-shrink-0 gap-4" />,
    warning: <AlertTriangle className="h-5 w-5 text-amber-600 flex-shrink-0 gap-4" />,
    error: <AlertCircle className="h-4 w-4 text-red-600 flex-shrink-0 gap-4" />,
    info: <Loader2 className="h-5 w-5 text-blue-600 animate-spin flex-shrink-0 gap-4" />,
  };
  return (
...
export default function FlightAmendmentWorkflow({
  ...
  const [step, setStep] = useState<'view' | 'search' | 'compare' | 'user_approval' | 'finalize'>(
    'view'
  );
              ...
              <CardContent className="space-y-4 p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 border rounded-lg bg-muted">
                    <h4 className="font-semibold text-sm text-foreground mb-3">Flight Details</h4>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {amendment.requestedDate && (
                        <div className="flex justify-between gap-4">
                          ...
                          <span className="font-medium">
                            {new Date(amendment.requestedDate).toLocaleDateString()}
                          </span>
                        </div>
                      )}
                      {amendment.requestedRoute && (
                        <div className="flex justify-between gap-4">
                          <span className="text-muted-foreground">Desired Route:</span>
                          <span className="font-medium">
                      ...
                      {amendment.requestReason && (
                        <div className="mt-3 pt-3 border-t border-blue-200">
                          <p className="text-muted-foreground text-xs mb-1">User Reason:</p>
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1 gap-4">
                              ...
                              <div className="flex items-center gap-3 mt-2 text-sm">
                                ...
                                <span className="text-muted-foreground">{flight.arrivalTime}</span>
                              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="border-2 border-emerald-500 rounded-lg p-4 bg-emerald-50">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <p className="text-muted-foreground">{selectedFlight.departureTime}</p>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4 p-6">
                    ...
                    {offers.financialImpact.adjustmentType !== 'none' && (
                      <AlertBox
                        type={
                          offers.financialImpact.adjustmentType === 'refund' ? 'success' : 'warning'
                        }
                      >
                        <div>
                          <p className="font-semibold">
                          ...
                          <p className="text-lg font-bold mt-1">
                            {offers.financialImpact.currency}{' '}
                            {Math.abs(offers.financialImpact.adjustmentAmount).toFixed(2)}
                          </p>
          ...
          <TabsContent value="user_approval" className="space-y-4">
            <Card>
              <CardHeader className="space-y-0 gap-2">
                ...
                <CardDescription>
                  An approval link has been sent to {amendment.traveler}. They have 24 hours to
                  respond.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6 p-6">
                <AlertBox type="info">
                  <div>
                    ...
                    <p className="text-sm mt-2">
                      We're waiting for the traveler to review and approve the financial changes and
                      new itinerary.
                    </p>
                  </div>
                </AlertBox>
                ...
                {selectedFlight && offers && (
                  <div className="space-y-3">
                    <h4 className="font-semibold text-foreground">What's Awaiting Approval:</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-3 border rounded-lg">
                        <p className="text-sm text-muted-foreground mb-2">New Flight Details</p>
                      ...
                      <div className="p-3 border rounded-lg">
                        <p className="text-sm text-muted-foreground mb-2">Financial Impact</p>
                        <Badge
                          variant="default"
                          className={
                            offers.financialImpact.adjustmentType === 'refund'
                ...
                <AlertBox type="warning">
                  <p>
                    Once the traveler approves, you must finalize the amendment to complete the
                    process. They will receive confirmation immediately after.
                  </p>
                </AlertBox>
              </CardContent>
            </Card>
          ...
          <TabsContent value="finalize" className="space-y-4">
            <AlertBox type="success">
              ...
              <p className="text-sm mt-1">
                All details are confirmed. Click below to finalize and process the flight amendment.
              </p>
            </AlertBox>
                ...
                <CardContent className="space-y-4 p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-3 bg-muted rounded-lg">
                      ...
                      <p className="font-semibold text-foreground">{amendment.traveler}</p>
                    </div>
                  </div>

                  <div className="border-t pt-4">
                    <h4 className="font-semibold text-foreground mb-3">New Flight Assignment</h4>
                  ...
                  {offers.financialImpact.adjustmentType !== 'none' && (
                    <div className="border-t pt-4">
                      <h4 className="font-semibold text-foreground mb-3">Financial Settlement</h4>
                      <AlertBox
                        type={
                          offers.financialImpact.adjustmentType === 'refund' ? 'success' : 'warning'
                        }
        ...
        <DialogFooter>
          {step === 'finalize' && (
            <>
              ...
              <Button onClick={handleFinalizeAmendment} disabled={loading} className="hover:">
                {loading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                Finalize Amendment
              </Button>
            </>

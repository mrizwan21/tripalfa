  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-2">
        <div>
          <h1 className="text-2xl font-semibold text-foreground">New Booking (Online)</h1>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 p-6">
              ...
              {hotelResults.length > 0 && (
                <div className="lg:col-span-3">
                  <h4 className="mb-3 text-sm font-semibold text-foreground">Available Hotels</h4>
          ...
          <Card>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 p-6">
              ...
              {flightResults.length > 0 && (
                <div className="lg:col-span-3">
                  <h4 className="mb-3 text-sm font-semibold text-foreground">Available Flights</h4>
                  <div className="space-y-2">

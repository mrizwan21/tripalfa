    ...
    <div className="space-y-6 relative">
      ...
      >
        <div>
          ...
          <p className="text-sm text-cyan-400/60 mt-1">
            Manage your agency balance and view transaction history.
          </p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <Button
            size="sm"
            className="h-9 gap-2 bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-400 hover:to-purple-400 text-white shadow-lg shadow-cyan-500/25"
          >
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6 text-white shadow-lg border border-cyan-500/20"
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4 gap-2">
              ...
              <Badge className="bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-400 border-cyan-500/30 text-xs">
                Active
              </Badge>
            </div>
        ...
        >
          <Card className="h-full border-cyan-500/10 bg-gradient-to-br from-slate-900/80 to-slate-950/90 hover:border-cyan-500/30 transition-colors">
            <CardHeader className="pb-2 space-y-0 gap-2">
            ...
            <CardContent>
              <div className="flex items-baseline gap-2">
                ...
                <span className="flex items-center text-xs font-medium text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-full border border-emerald-500/30 gap-2">
                  <TrendingUp className="h-3 w-3 mr-0.5" />
                  +14%
                </span>
              </div>
              <p className="text-xs text-muted-foreground mt-1">vs $10,920 last month</p>
              ...
              <div className="h-12 mt-4 flex items-end justify-between gap-1">
                {[30, 45, 25, 60, 75, 50, 80].map((height, i) => (
                  <motion.div
                    ...
                    className="flex-1 bg-gradient-to-t from-cyan-500/50 to-purple-500/50 rounded-sm hover:from-cyan-500/70 hover:to-purple-500/70 transition-colors gap-4"
                  />
                ))}
              </div>
            </CardContent>
          ...
          <Card className="h-full border-cyan-500/10 bg-gradient-to-br from-slate-900/80 to-slate-950/90 hover:border-cyan-500/30 transition-colors">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Total value: <span className="text-amber-400">$450.00</span>
              </p>
              <Button
                variant="outline"
                size="sm"
                className="w-full mt-4 h-8 text-xs border-amber-500/20 text-amber-400 hover:bg-amber-500/5 hover:border-amber-500/40 bg-transparent"
              >
                Resolve Requests
      ...
      <div className="grid gap-6 lg:grid-cols-7">
        ...
        >
          <Card className="border-cyan-500/10 bg-gradient-to-br from-slate-900/80 to-slate-950/90">
            <CardHeader className="pb-3 border-b border-cyan-500/10 space-y-0 gap-2">
              <div className="flex items-center justify-between gap-2">
                <div>
                  ...
                  <CardDescription className="text-xs mt-1 text-muted-foreground">
                    Most recent 5 transactions from your wallet
                  </CardDescription>
                </div>
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-xs h-8 text-cyan-400 hover:text-cyan-300 hover:/5"
                >
                  View All
                  <ChevronRight className="h-3 w-3 ml-1" />
                </Button>
              ...
              <div className="divide-y divide-cyan-500/10">
                {transactions.map((transaction, index) => (
                  <motion.div
                    ...
                    className="flex items-center justify-between py-4 first:pt-0 last:pb-0 hover:bg-cyan-500/5 transition-colors -mx-6 px-6 gap-2"
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={cn(
                          'h-10 w-10 rounded-xl flex items-center justify-center',
                          getTransactionStyles(transaction.type)
                        )}
                      >
        ...
        >
          <Card className="border-cyan-500/10 bg-gradient-to-br from-slate-900/80 to-slate-950/90 h-full">
            <CardHeader className="pb-3 border-b border-cyan-500/10 space-y-0 gap-2">
              <CardTitle className="text-base font-semibold text-white flex items-center gap-2">
            ...
            <CardContent className="space-y-4 pt-4">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Button
                  variant="outline"
                  size="default"
                  className="relative h-5 w-9 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full cursor-pointer transition-colors shadow-lg shadow-cyan-500/25"
                >
              ...
              {/* Auto-Topup */}
              <div className="flex items-center justify-between gap-2">
                <span className="text-sm text-muted-foreground">Auto-Topup</span>
                <Button
                  variant="outline"
                  size="default"
                  className="relative h-5 w-9 bg-muted rounded-full cursor-pointer transition-colors hover:bg-muted/80"
                >
              ...
              <div className="pt-4 mt-4 border-t border-cyan-500/10">
                ...
                <div className="flex items-center gap-3 p-3 border border-cyan-500/20 rounded-xl bg-cyan-500/5 hover:border-cyan-500/40 transition-colors cursor-pointer">
                  <div className="h-8 w-10 bg-gradient-to-br from-muted to-muted/80 rounded flex items-center justify-center border border-border gap-2">
                    <span className="text-[6px] text-white font-bold">VISA</span>
                  </div>
                  <div className="flex-1 gap-4">
                    <span className="text-xs font-mono text-muted-foreground">**** 5599</span>

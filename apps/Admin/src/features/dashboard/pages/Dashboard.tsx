    ...
    <div className="flex-1 space-y-6 relative">
      ...
      >
        <div>
          ...
          <p className="text-cyan-400/60 mt-1">Here's what's happening with your business today.</p>
        </div>
          ...
          <CardContent className="space-y-4 p-6">
            ...
            <div className="pt-2 border-t border-cyan-500/10">
              <div className="flex items-center justify-between text-xs gap-2">
                <span className="text-muted-foreground">Last check: 2 min ago</span>
                <Button
                  variant="ghost"
                  size="sm"
              ...
              <div key={location.city} className="space-y-2">
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-foreground/90">{location.city}</span>
                  </div>

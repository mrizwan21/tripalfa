  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-2">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Marketing & Branding</h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Card>
              <CardHeader className="space-y-0 gap-2">
                ...
                <CardDescription>Quick-start color combinations for your brand</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="space-y-0 gap-2">
                ...
                <CardDescription>Fine-tune your brand colors using HSL format</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="preview">
          <Card>
            ...
            <CardContent>
              <div className="rounded-xl border bg-card p-8" style={getPreviewStyles()}>
                {/* Header Preview */}
                ...
                <div className="mt-8 flex justify-center gap-2">
                  <Badge className="bg-[hsl(var(--preview-primary))]">New</Badge>
                  <Badge className="bg-[hsl(var(--preview-accent))]">Popular</Badge>
                </div>
              </div>

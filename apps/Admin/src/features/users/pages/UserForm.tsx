  ...
  useEffect(() => {
    const loadAllData = async () => {
      try {
        ...
        const [countriesRes, nationalitiesRes, doctypesRes, statesRes, citiesRes, permsRes] =
          await Promise.all([
                          ...
                          >
                            ...
                            <SelectContent>
                              {dropdownOptions.states
                                .filter(
                                  state => !selectedCountry || state.countryId === selectedCountry
                                )
                                .map(state => (
                      ...
                      <div key={permission.id} className="border rounded-lg p-4">
                        <div className="flex items-center justify-between mb-3 gap-2">
                          <div className="flex items-center gap-3">
                            ...
                            />
                            <Label className="font-medium text-sm">{permission.name as any}</Label>
                          </div>
                        </div>
                ...
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <p className="text-xs text-muted-foreground">pdf, jpeg, png, and jpg</p>
                      <input
                        type="file"
                        className="hidden"
                        id="file-upload"

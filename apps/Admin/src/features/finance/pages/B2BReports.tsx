...
type FinancialSummary = Record<string, any>;
type ServiceBreakdown = Record<string, any>;
type TopDestination = Record<string, any>;
...
export const b2bColumns: ColumnDef<B2BCompanyReport>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <span className="font-mono font-semibold">${revenue.toLocaleString()}</span>;
    },
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <span className="font-mono text-green-600">${commission.toLocaleString()}</span>;
    },
  },
  {
  ...
  return (
    <div className="container mx-auto py-6">
          ...
          <CardContent>
            <div className="space-y-4">
              {serviceBreakdown.map(service => (
                <div key={service.serviceType} className="flex items-center gap-2">
          ...
          <CardContent>
            <div className="space-y-3">
              {topDestinations.slice(0, 5).map((dest, index) => (
                <div key={dest.destination} className="flex items-center justify-between gap-2">
      ...
      <Card>
        ...
        <CardContent>
          <DataTable columns={b2bColumns} data={data} searchKey="companyName" />
        </CardContent>
      </Card>
    </div>
  );

  ...
  return (
    <div className="flex h-screen bg-background gap-4">
      ...
      <aside
        ...
        } bg-gradient-to-b from-background via-muted/30 to-background text-foreground transition-all duration-300 border-r border-cyan-500/10 hidden md:flex flex-col relative overflow-hidden`}
      >
        {/* Animated background effect */}
        <div className="absolute inset-0 bg-gradient-to-b from-cyan-500/5 via-transparent to-purple-500/5 pointer-events-none" />

        {/* Logo */}
        <div className="p-6 border-b border-cyan-500/10 flex items-center justify-between relative z-10 gap-2">
          {sidebarOpen && (
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-cyan-400 via-purple-500 to-pink-500 rounded-xl flex items-center justify-center shadow-lg relative overflow-hidden gap-2">
                <div className="absolute inset-0 bg-gradient-to-tr from-white/20 to-transparent" />
                <Car className="w-5 h-5 relative z-10" />
              </div>
              <div>
                <h1 className="text-lg font-bold gradient-text text-3xl font-bold tracking-tight">
                  TripAlfa
                </h1>
              ...
              <div
                className={`flex h-9 w-9 items-center justify-center rounded-lg transition-all duration-300 ${
                  item.active
                    ...
                    : "bg-muted/50 text-muted-foreground group-hover:text-cyan-400 group-hover:bg-cyan-500/10"
                }`}
              >
        ...
        <div className="p-4 border-t border-cyan-500/10 space-y-2 relative z-10">
          <Button
            ...
            className="w-full px-4 py-2 text-muted-foreground hover:text-cyan-400 hover:bg-cyan-500/5 rounded-xl transition-colors text-sm border border-transparent hover:border-cyan-500/20"
          >
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <div className="absolute inset-0 grid-bg pointer-events-none opacity-50 gap-4" />
        ...
        {/* Header */}
        <header className="bg-background/80 backdrop-blur-xl border-b border-cyan-500/10 px-6 py-4 flex items-center justify-between relative z-20 gap-2">
          <div className="flex items-center gap-4 flex-1">
            ...
            <Button
              ...
              className="md:hidden p-2 hover:bg-cyan-500/5 rounded-lg text-muted-foreground hover:text-cyan-400 transition-colors"
            >
              {menuOpen ? (
                <X className="w-5 h-5" />
              ) : (
            ...
            <div className="flex-1 max-w-md gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-cyan-500/20 bg-cyan-500/5 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-cyan-500/30 focus:border-cyan-500/30 transition-all"
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Bell className="w-5 h-5 text-muted-foreground hover:text-cyan-400" />
            ...
            >
              {isDarkMode ? (
                ...
                <Moon className="w-5 h-5 text-muted-foreground hover:text-cyan-400" />
              )}
            </Button>

            {/* User Profile */}
            <div className="flex items-center gap-3 pl-3 border-l border-cyan-500/10">
              <div className="w-9 h-9 bg-gradient-to-br from-cyan-400 via-purple-500 to-pink-500 rounded-xl flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-cyan-500/25 gap-2">
                AR
              </div>
        ...
        {/* Page Content */}
        <main className="flex-1 overflow-auto relative z-10 gap-4">

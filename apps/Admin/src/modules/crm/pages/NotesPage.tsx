      ...
      <CardContent className="pt-6">
        <div className="space-y-3">
          <div className="flex items-start justify-between gap-2">
            ...
            {note.isPinned && <span className="text-orange-500">📌</span>}
          </div>
    ...
    <div className="space-y-5">
      ...
      <div className="action-row">
        <div>
          ...
          <p className="text-caption mt-1">Internal notes, comments, and collaboration</p>
        </div>
      ...
      {selectedNote && (
        <Card className="border-2 border-blue-500">
          ...
          <CardContent className="space-y-6">
            <div>
              <StatusBadge
                status={getTypeStatusForBadge(selectedNote.type)}
            ...
            <Button variant="outline" className="w-full" onClick={() => setSelectedNote(null)}>
              Close
            </Button>
          </CardContent>
        </Card>
      ...
      <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>Add an internal note for your team</DialogDescription>
          </DialogHeader>

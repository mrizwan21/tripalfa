    ...
    <div className="data-grid">
      <div className="metric-card">
        <div className="text-center">
          ...
          <p className="text-success text-caption mt-1">
            ↑ {metrics?.contacts.newThisMonth || 0} new this month
          </p>
        </div>
      </div>
      <div className="metric-card">
      ...
      <div className="metric-card">
        <div className="text-center">
          ...
          <p className="text-page-title mt-2">
            {metrics?.engagement.avgEngagementScore?.toFixed(1) || 0}
          </p>
          ...
          {isLoading ? (
            ...
            <div className="empty-state">
              ...
              <p className="empty-state-description">
                Start adding prospects to build your sales pipeline
              </p>
            </div>
          )}
        </div>
        ...
        <div className="p-4">
          <div className="space-y-4">
            {[
              {
                status: 'Leads',
                count: metrics?.contacts.leads || 0,
                total: metrics?.contacts.total || 1,
              },
              {
                status: 'Prospects',
                count: metrics?.contacts.active || 0,
                total: metrics?.contacts.total || 1,
              },
              {
                status: 'Customers',
                count:
                  metrics?.contacts.total -
                    (metrics?.contacts.leads || 0) -
                    (metrics?.contacts.active || 0) || 0,
                total: metrics?.contacts.total || 1,
              },
            ].map((item, idx) => (

...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      // Extended border radius - Optics Materials standard
      borderRadius: {
        DEFAULT: '4px',
        xs: '4px',
        sm: '4px',
      ...
      // Surface elevation levels - Optics Materials
      boxShadow: {
      ...
      backgroundImage: {
        'gradient-primary': 'linear-gradient(to right, rgb(59 130 246), rgb(168 85 247))',
        'gradient-primary-dark': 'linear-gradient(to right, rgb(37 99 235), rgb(147 51 234))',
        'gradient-success': 'linear-gradient(to right, rgb(16 185 129), rgb(5 150 105))',
        'gradient-warning': 'linear-gradient(to right, rgb(251 191 36), rgb(249 115 22))',
        'gradient-error': 'linear-gradient(to right, rgb(239 68 68), rgb(220 38 38))',
        'gradient-dashboard':

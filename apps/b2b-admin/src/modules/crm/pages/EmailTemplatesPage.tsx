...
export default function EmailTemplateBuilder() {
  ...
  const getTemplateStatusForBadge = (status: string): 'primary' | 'info' | 'warning' | 'success' | 'default' => {
    const statusMap = {
  ...
  const emailBlocks = [
    { name: 'Heading', content: '<h1 style="font-size: 24px; font-weight: bold;">Your heading here</h1>' },
    { name: 'Paragraph', content: '<p style="font-size: 14px; line-height: 1.6;">Your text here</p>' },
    { name: 'Button', content: '<a href="https://example.com" style="background: #3b82f6; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block;">Click here</a>' },
    { name: 'Divider', content: '<hr style="border: none; border-top: 1px solid #e5e7eb; margin: 20px 0;" />' },
  ];
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <StatusBadge status={getTemplateStatusForBadge(template.status)} label={template.status} size="sm" />
                        </div>

...
interface ConnectedAccount {
  id: string;
  name: string;
  providerType: 'GMAIL' | 'OUTLOOK' | 'SLACK' | 'STRIPE' | 'ZAPIER' | 'DUFFEL' | 'LITEAPI' | 'OTROS';
...
export default function ConnectedAccountsPage() {
  ...
  const [selectedFilter, setSelectedFilter] = useState<'ALL' | 'CONNECTED' | 'ERROR'>(
    'ALL'
  );
  ...
  const getProviderStatus = (provider: string): 'primary' | 'info' | 'warning' | 'success' | 'default' => {
    const statusMap = {
      GMAIL: 'info' as const,
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-3 flex-wrap">
                        <StatusBadge status={getProviderStatus(account.providerType)} label={account.providerType} size="sm" />
        ...
        <Card className="border-2 border-blue-500">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <StatusBadge status={getProviderStatus(selectedAccount.providerType)} label={selectedAccount.providerType} size="sm" />
            </div>

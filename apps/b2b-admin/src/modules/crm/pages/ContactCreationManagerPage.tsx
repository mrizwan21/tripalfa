...
export default function ContactCreationManagerPage() {
  ...
  const { data: forms, isLoading, refetch } = useQuery<ContactForm[]>({
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button size="sm" variant="ghost" onClick={() => deleteFormMutation.mutate(form.id)}>
                        <Trash2 size={16} />
                      </Button>
                    </div>
                  </div>
      ...
      <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => createFormMutation.mutate(newForm)}>
              Create
            </Button>
          </DialogFooter>
        </DialogContent>

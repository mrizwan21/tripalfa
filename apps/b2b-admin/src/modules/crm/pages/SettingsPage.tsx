  ...
  return (
    <div className="space-y-5">
      ...
      <div className="action-row">
        ...
        <p className="text-caption mt-1">Configure CRM preferences, notifications, and data management</p>
      </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Get notified when a new contact is added</p>
                  </div>
                  <input
                    type="checkbox"
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Get notified when activities are logged</p>
                  </div>
                  <input
                    type="checkbox"
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Get notified when a hot lead is identified</p>
                  </div>
                  <input
                    type="checkbox"
        ...
        <TabsContent value="campaigns" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure default values for new email campaigns
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    className="mt-2"
                  />
                  <p className="text-xs text-muted-foreground mt-1">The name that appears in recipients' inbox</p>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="mt-2"
                  />
                  <p className="text-xs text-muted-foreground mt-1">Must be a verified sending address</p>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="mt-2"
                  />
                  <p className="text-xs text-muted-foreground mt-1">Where recipients' replies are sent</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Add unsubscribe link to campaigns for compliance</p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <Input
                      ...
                      className="w-24"
                    />
                    <span className="text-sm text-muted-foreground self-center">months of inactivity</span>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <Input
                      ...
                      className="w-24"
                    />
                    <span className="text-sm text-muted-foreground self-center">months after archiving</span>
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                You can export all your contacts, activities, and campaigns for backup or analysis purposes.
              </p>

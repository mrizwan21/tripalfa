...
export default function WorkflowPage() {
  ...
  const [selectedStatus, setSelectedStatus] = useState<Workflow['status'] | 'ALL'>(
    'ALL'
  );
  ...
  const getWorkflowStatusForBadge = (status: string): 'primary' | 'info' | 'warning' | 'success' | 'default' => {
    const statusMap = {
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-3 flex-wrap">
                        ...
                        <StatusBadge status={getWorkflowStatusForBadge(workflow.status)} label={workflow.status} size="sm" />

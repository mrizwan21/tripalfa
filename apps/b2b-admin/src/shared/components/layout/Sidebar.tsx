...
export function Sidebar() {
  ...
  return (
    <div className="flex h-screen w-72 flex-col bg-[#050810] text-slate-300 border-r border-cyan-500/10">
      {/* Logo Section */}
                      ...
                      {hasChildren ? (
                        ...
                        >
                          ...
                          <div className={cn(
                            ...
                            isActive || isExpanded
                              ? "bg-gradient-to-br from-cyan-400 to-purple-500 text-white shadow-lg neon-glow-cyan"
                          ...
                          {item.badge && (
                            <span className="flex h-5 min-w-[20px] items-center justify-center rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 px-2 text-[10px] font-semibold text-cyan-400 border border-cyan-500/30">
                              {item.badge}
                            </span>
                          )}
        ...
        <div className="rounded-xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-4 border border-cyan-500/10 relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 relative z-10">
            <div className="relative">
              ...
              <div className="absolute -bottom-0.5 -right-0.5 h-3.5 w-3.5 rounded-full bg-emerald-400 border-2 border-[#050810] shadow-lg shadow-emerald-500/50" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-white truncate">Admin User</p>
              <p className="text-xs text-cyan-400/70 truncate">admin@tripalfa.com</p>
            </div>
            <button className="p-2 rounded-lg text-slate-500 hover:text-cyan-400 hover:bg-cyan-500/10 transition-colors">

    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-2">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage supplier profiles, products, and documentation
          </p>
        </div>
        <Button onClick={handleAddSupplier} className="hover: text-white">
      ...
      <Card>
        <CardHeader className="space-y-0 gap-2">
          <CardTitle>Suppliers ({pagination.total})</CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
      ...
      >
        <AlertDialogContent>
          ...
          <AlertDialogDescription>
            ...
            undone and will remove all associated products, documents, and
            records.
          </AlertDialogDescription>
          <AlertDialogFooter>

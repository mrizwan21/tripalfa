...
export function FlightBookingForm({ mode, initialData, onSubmit, onCancel }: FlightBookingFormProps) {
  ...
  const [segments, setSegments] = useState<FlightSegment[]>(initialData?.segments || []);

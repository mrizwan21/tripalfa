  ...
  return {
    ...
    pricing: {
      markupPercent: toNumber(
        ...
        DEFAULT_RUNTIME_CONFIG.pricing.markupPercent,
      ),
      markupFlat: toNumber(
        pricing.markupFlat,
        DEFAULT_RUNTIME_CONFIG.pricing.markupFlat,
      ),
    ...
    branding: {
      appName: toStringValue(
        branding.appName,
        DEFAULT_RUNTIME_CONFIG.branding.appName,
      ),
      logoUrl: toStringValue(
        branding.logoUrl,
        DEFAULT_RUNTIME_CONFIG.branding.logoUrl,
      ),
      defaultAvatarUrl: toStringValue(
        branding.defaultAvatarUrl,
        DEFAULT_RUNTIME_CONFIG.branding.defaultAvatarUrl,
      ),
      rtlEnabled: toBoolean(
        branding.rtlEnabled,
        DEFAULT_RUNTIME_CONFIG.branding.rtlEnabled,
      ),
    },
  };
}

function extractRuntimePayload(
  responseData: any,
...
export default function BookingEngineRuntimeSettings() {
  ...
  const loadConfig = async () => {
    try {
      ...
      const normalized = normalizeRuntimeConfig(
        extractRuntimePayload(response.data),
      );
  ...
  const updateBranding = (
    key: keyof TenantBrandingConfig,
  ...
  const toggleAllowedMethod = (method: PaymentMethodId, enabled: boolean) => {
    setConfig((prev) => {
      ...
      const safeMethods: PaymentMethodId[] =
        nextMethods.length > 0 ? nextMethods : ["wallet"];

      const nextDefault: PaymentMethodId = safeMethods.includes(
    ...
    <div className="container mx-auto py-8 space-y-6">
      <div className="flex items-center justify-between gap-2">
        <div>
          <h1 className="text-3xl font-bold text-foreground">
            Booking Engine Runtime
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            Manage dynamic booking engine features, pricing, checkout policy,
            and branding runtime values.
          </p>
        </div>
      ...
      <Card>
        <CardHeader className="space-y-0 gap-2">
          ...
          <CardDescription>
            Toggle user-facing booking engine features per tenant.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 md:grid-cols-2 p-6">
          <div className="flex items-center justify-between rounded-lg border p-3 gap-2">
            ...
            <Switch
              ...
              onCheckedChange={(value) =>
                updateFeature("flightBookingEnabled", value)
              }
          ...
          <div className="flex items-center justify-between rounded-lg border p-3 gap-2">
            ...
            <Switch
              ...
              onCheckedChange={(value) =>
                updateFeature("hotelBookingEnabled", value)
              }
              disabled={!canManageRuntime}
            />
          </div>
          ...
          <div className="flex items-center justify-between rounded-lg border p-3 gap-2">
            ...
            <Switch
              ...
              onCheckedChange={(value) =>
                updateFeature("walletTopupEnabled", value)
              }
              disabled={!canManageRuntime}
            />
          </div>
          <div className="flex items-center justify-between rounded-lg border p-3 gap-2">
            ...
            <Switch
              ...
              onCheckedChange={(value) =>
                updateFeature("seatSelectionEnabled", value)
              }
              disabled={!canManageRuntime}
            />
          </div>
          <div className="flex items-center justify-between rounded-lg border p-3 gap-2">
            ...
            <Switch
              ...
              onCheckedChange={(value) =>
                updateFeature("ancillariesEnabled", value)
              }
              disabled={!canManageRuntime}
            />
          </div>
      ...
      <Card>
        <CardHeader className="space-y-0 gap-2">
          ...
          <CardDescription>
            Set tenant-level markup and commission behavior.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 md:grid-cols-2 p-6">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                updatePricing("markupPercent", parseNumberInput(e.target.value))
              }
              disabled={!canManageRuntime}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                updatePricing("markupFlat", parseNumberInput(e.target.value))
              }
              disabled={!canManageRuntime}
            />
          </div>
          ...
          <div className="flex items-center justify-between rounded-lg border p-3 md:col-span-2 gap-2">
            <Label htmlFor="commissionChargeableToCustomer">
              Charge commission to customer
            </Label>
            <Switch
              id="commissionChargeableToCustomer"
              checked={config.pricing.commissionChargeableToCustomer}
              onCheckedChange={(value) =>
                updatePricing("commissionChargeableToCustomer", value)
              }
              disabled={!canManageRuntime}
            />
          </div>
      ...
      <Card>
        <CardHeader className="space-y-0 gap-2">
          ...
          <CardDescription>
            Control payment methods and checkout defaults.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 p-6">
          ...
          <div className="space-y-2">
            ...
            <div className="grid gap-2 md:grid-cols-2">
              {paymentMethods.map((method) => {
                const checked =
                  config.checkout.allowedPaymentMethods.includes(method);
                ...
                return (
                  ...
                  >
                    ...
                    <Switch
                      ...
                      onCheckedChange={(value) =>
                        toggleAllowedMethod(method, value)
                      }
                    />
                  </div>
                );
          ...
          <div className="flex items-center justify-between rounded-lg border p-3 gap-2">
            <Label htmlFor="enforceSupplierWallet">
              Enforce supplier wallet
            </Label>
            <Switch
              id="enforceSupplierWallet"
              checked={config.checkout.enforceSupplierWallet}
              onCheckedChange={(value) =>
                updateCheckout("enforceSupplierWallet", value)
              }
              disabled={!canManageRuntime}
            />
          </div>
      ...
      <Card>
        <CardHeader className="space-y-0 gap-2">
          ...
          <CardDescription>
            Runtime branding values consumed by booking engine.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 md:grid-cols-2 p-6">
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                updateBranding("defaultAvatarUrl", e.target.value)
              }
              disabled={!canManageRuntime}
            />
          </div>

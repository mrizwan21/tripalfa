...
const { Plus, Trash2, Copy } = Icons as any;
...
export const ActionConfigurator: React.FC<ActionConfiguratorProps> = ({
  ...
  const handleDuplicateAction = useCallback(
    (id: string) => {
      ...
      const updated = actionList.map((a) =>
        a.order >= newAction.order ? { ...a, order: a.order + 1 } : a,
      );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-2">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Define actions to execute when condition matches
          </p>
          {executionMode === "sequential" && (
      ...
      {isAddingAction && (
        <ActionForm
          action={
            editingId ? actionList.find((a) => a.id === editingId) : undefined
          }
        ...
        <div>
          ...
          <div className="flex items-center gap-2 pt-2">
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, async: e.target.checked })
              }
              disabled={disabled || isSubmitting}
              className="rounded"
            />
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onConfigChange({ ...config, channels: e.target.value })
                }
                disabled={disabled}
                className="
                  w-full px-3 py-2 border border-border rounded-lg text-sm
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onConfigChange({ ...config, priority: e.target.value })
                }
                disabled={disabled}
                className="
                  w-full px-3 py-2 border border-border rounded-lg text-sm
          ...
          <div className="space-y-3">
            <div>
              ...
              <textarea
                ...
                disabled={disabled}
                className="
                  w-full px-3 py-2 border border-border rounded-lg text-sm font-mono
                  focus:outline-none focus:ring-2 focus:ring-blue-500
                  disabled:bg-muted disabled:cursor-not-allowed
                "
              />
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onConfigChange({ ...config, toEmail: e.target.value })
                }
                disabled={disabled}
                className="
                  w-full px-3 py-2 border border-border rounded-lg text-sm
      ...
      <div className="flex items-center gap-4">
        <div className="flex flex-col gap-1">
          <Button
            ...
            className="text-xs text-muted-foreground hover:text-foreground disabled:opacity-30 px-4 py-2 rounded-md"
          >
            ▲
          </Button>

      ...
      <div className="space-y-3">
        {endpoints.map((endpoint) => (
          <button
            ...
            className={`w-full group text-left bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:border-slate-300 dark:hover:border-slate-600 ${

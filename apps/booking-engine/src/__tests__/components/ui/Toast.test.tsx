...
describe('Toaster Component', () => {
  describe('Multiple toasts', () => {
    ...
    it('should handle removing toasts', async () => {
      ...
      const { rerender } = render(<Toaster toasts={toasts} onRemove={onRemove} />);
  ...
  describe('Toast stacking', () => {
    it('should display toasts in stack order', () => {
      ...
      const { container } = render(<Toaster toasts={toasts} onRemove={vi.fn()} />);
  ...
  describe('Position prop', () => {
    it('should apply position class to toaster container', () => {
      ...
      const positionContainer = Array.from(container.querySelectorAll('[class*="fixed"]')).find(
        (el) => el.className.includes('bottom-4')
      );
  ...
  describe('Edge cases', () => {
    ...
    it('should handle very long toast messages', () => {
      const longMessage = 'This is a very long notification message that should wrap properly without breaking the layout or causing overflow issues.';
      const toasts = [
        {
          id: '1',
          type: 'info' as const,

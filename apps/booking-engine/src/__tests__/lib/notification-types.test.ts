...
describe('notification-types', () => {
  describe('Type Definitions', () => {
    ...
    it('should define all notification statuses', () => {
      const statuses: NotificationStatus[] = ['PENDING', 'CONFIRMED', 'REJECTED', 'INFO', 'CANCELLED'];
  ...
  describe('Mock Data Validation', () => {
    ...
    it('should have notifications with correct type values', () => {
      const validTypes: NotificationType[] = ['SUCCESS', 'INFO', 'WARNING', 'ERROR'];
      MOCK_NOTIFICATIONS.forEach((notification) => {
    ...
    it('should have notifications with correct status values', () => {
      const validStatuses: NotificationStatus[] = ['PENDING', 'CONFIRMED', 'REJECTED', 'INFO', 'CANCELLED'];
      MOCK_NOTIFICATIONS.forEach((notification) => {
    ...
    it('INFO notifications should have valid when field', () => {
      const infoNotifications = MOCK_NOTIFICATIONS.filter((n) => n.type === 'INFO');

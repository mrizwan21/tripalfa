...
export const ReceivePaymentModal: React.FC<ReceivePaymentModalProps> = ({
  ...
  const [amount, setAmount] = useState<string>(
    outstandingAmount > 0 ? outstandingAmount.toString() : "0",
  );
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Top Up Wallet">
      <form onSubmit={handleSubmit} className="p-4 space-y-4">
        <div className="bg-blue-50 p-3 rounded-lg text-sm text-blue-700 mb-4">
          All payments are processed as wallet top-ups. Funds will be added to
          the customer's wallet and can be used for this or future bookings.
        </div>

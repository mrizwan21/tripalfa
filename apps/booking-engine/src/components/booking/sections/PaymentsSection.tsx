    ...
    <div className="space-y-6">
          ...
          <div className="flex justify-between items-start mb-4 gap-4">
            <div>
              ...
              <h2 className="text-3xl font-bold tracking-tight">
                {wallet
                  ? `${wallet.currency} ${wallet.amount.toLocaleString(undefined, { minimumFractionDigits: 2 })}`
                  : "..."}
              </h2>
            </div>
            <button
              onClick={() => setIsTopUpOpen(true)}
              className="bg-card/20 hover:bg-card/30 text-white backdrop-blur-sm border border-border/30 px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-all"
            >
      ...
      <div>
        ...
        <div className="border border-[var(--color-border-light)] rounded-lg p-3 bg-[var(--color-bg-secondary)]">
          ...
          <div className="border-t border-[var(--color-border-light)] mt-3 pt-2 flex justify-between items-center gap-4">

    ...
    <div className="space-y-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                <span className="text-xs text-[var(--color-text-tertiary)]">
                  {flightDetails.departureTime
                    ? format(new Date(flightDetails.departureTime), "HH:mm")
                    : ""}
                </span>
              </div>
              <div className="flex-1 border-t border-dashed border-[var(--color-border-dark)] mx-4 relative top-[-8px] gap-4"></div>
              <div className="flex flex-col text-right gap-4">
                ...
                <span className="text-xs text-[var(--color-text-tertiary)]">
                  {flightDetails.arrivalTime
                    ? format(new Date(flightDetails.arrivalTime), "HH:mm")
                    : ""}
                </span>
              </div>
            </div>
      ...
      {isHotel && hotelDetails && (
        <Card className="bg-[var(--color-bg-secondary)] border-[var(--color-border-light)] shadow-none">
          ...
          <CardContent className="text-sm space-y-2 p-6">

    ...
    <div className="hold-order-details">
      ...
      <div className="details-grid gap-4">
        ...
        <section className="detail-section deadline">
          ...
          <div className="detail-item">
            ...
            <span className="value date">{formatDate(holdOrder.paymentRequiredBy)}</span>
          </div>
          <div className="detail-item">
      ...
      {holdOrder.status === 'active' && holdOrder.paymentStatus === 'awaiting_payment' && (
        <div className="action-buttons">
          <div className="hold-payment-info">
            ...
            <p>
              No payment has been deducted from your wallet. Complete payment anytime before the
              deadline to finalize your booking.
            </p>
          </div>
          <button
      ...
      {holdOrder.status === 'paid' && (
        <div className="success-message">
          <p>
            ✓ Your booking has been confirmed and paid. Check your email for confirmations and
            booking documents.
          </p>
        </div>
      )}

    ...
    <div className="space-y-6 max-w-4xl mx-auto p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Choose which communication channels you want to receive
            notifications on
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6 p-6">
          {/* Email */}
          <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted transition-colors gap-2">
            <div>
      ...
      <Card>
        ...
        <CardContent className="space-y-6 p-6">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted transition-colors gap-2">
            <div>
              <h4 className="font-medium text-foreground">Price Drop Alerts</h4>
              <p className="text-sm text-muted-foreground mt-1">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted transition-colors gap-2">
            <div>
              <h4 className="font-medium text-foreground">Booking Reminders</h4>
              <p className="text-sm text-muted-foreground mt-1">
      ...
      <Card>
        ...
        <CardContent className="space-y-4 p-6">
          <p className="text-sm text-muted-foreground">
            Notifications will not be sent between your quiet hours. Urgent
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-border bg-background rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardContent className="pt-6">
          ...
          <p className="text-sm text-blue-800">
            You can update these preferences at any time. Changes take effect
            immediately.
          </p>
        </CardContent>
      </Card>

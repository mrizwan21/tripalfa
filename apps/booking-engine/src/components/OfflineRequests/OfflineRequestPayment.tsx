...
import { Loader2, AlertCircle, CheckCircle2, CreditCard, Wallet } from 'lucide-react';
...
export const OfflineRequestPayment: React.FC<OfflineRequestPaymentProps> = ({
  ...
  const processPaymentMutation = useMutation({
    ...
    onSuccess: (response) => {
      setTransactionId(response.transactionId || response.payment?.transactionRef || '');
      setStep('success');
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="pt-12 pb-12 text-center">
            ...
            <p className="text-green-700 mb-6">
              Your flight change has been confirmed and your new e-ticket is being generated.
            </p>

            <div className="bg-white rounded-lg p-6 mb-6 space-y-3 text-left">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              ...
              <ul className="text-sm text-blue-700 space-y-1 text-left">
                ...
                <li>✓ An updated invoice and receipt will be sent separately</li>
        ...
        <Card className="border-red-200 bg-red-50">
          <CardContent className="pt-8 pb-8">
            <div className="flex gap-4 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-red-900 mb-2">Payment Failed</h2>
            ...
            <div className="bg-red-100 border border-red-300 rounded p-4 mb-6">
              <p className="text-sm text-red-900">
                Your request is still active. Please try again with a different payment method or
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Request Reference: {request.requestRef}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 border-t pt-4">
          <div className="flex justify-between items-center">
            <span className="text-gray-600">Payment Amount</span>
            <span className="text-2xl font-bold text-indigo-700">{formatCurrency(amount)}</span>
          </div>
          ...
          >
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mt-1">Visa, Mastercard, or American Express</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Available Balance: <strong>{formatCurrency(paymentMethods.walletBalance)}</strong>
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          ...
          <br />
          We use industry-standard encryption to protect your payment information. Your card details

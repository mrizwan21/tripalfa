...
export const RequestStatus = ({ request, compact = false }: RequestStatusProps) => {
  ...
  if (compact) {
    return (
      <div className={`p-3 rounded-lg border ${getCardBgColor(request.status)}`}>
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm font-medium text-gray-700">Request Progress</p>
            <p className="text-xs text-gray-600">{Math.round(statusProgress)}%</p>
          </div>
        ...
        <div className="bg-white rounded-lg p-3 border border-gray-200 space-y-2">
          <p className="text-sm font-medium text-gray-900">Original Booking Details</p>
        ...
        {request.requestedChanges && (
          <div className="bg-white rounded-lg p-3 border border-gray-200 space-y-2">
            <p className="text-sm font-medium text-gray-900">Requested Changes</p>
        ...
        <div className="bg-white rounded-lg p-3 border border-gray-200">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-medium text-gray-900">${priceChange.original.toFixed(2)}</span>
            </div>
            ...
            <div className="flex items-center justify-between text-sm border-t pt-2">
              ...
              <span className="font-medium text-gray-900">${priceChange.proposed.toFixed(2)}</span>
            </div>
        ...
        <div className="text-xs text-gray-600 space-y-1">
          ...
          {request.reviewDeadline && (
            <p>⏰ Review By: {new Date(request.reviewDeadline).toLocaleString()}</p>
          )}
        </div>
      </CardContent>
    </Card>

    ...
    <aside className="hidden lg:block w-72 shrink-0">
      <div className="sticky top-24 space-y-6">
        ...
        <div className="bg-purple-50 rounded-[2rem] border border-purple-100/50 p-3">
          <p className="text-[10px] font-bold text-purple-600 uppercase tracking-widest mb-2 px-3">
            Admin Tools
          </p>
          <nav className="space-y-2">
            {ADMIN_LINKS.map((ln) => {
                    ...
                    <div
                      className={cn(
                        ...
                        active
                          ...
                          : "bg-purple-100/50 group-hover:bg-purple-100 text-purple-500",
                      )}
                    >
                      <Icon size={16} />
                    </div>
        ...
        <div className="bg-emerald-50 rounded-[2rem] p-6 border border-emerald-100/50">
          ...
          <Link
            to="/help"
            className="inline-flex items-center gap-2 text-[10px] font-bold text-emerald-600 bg-white px-4 py-2 rounded-full shadow-sm hover:shadow-md transition-all"
          >
            Contact Support
          </Link>
        </div>

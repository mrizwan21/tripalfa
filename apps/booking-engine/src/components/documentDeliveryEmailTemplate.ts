 ...
 */
export function generateDocumentDeliveryEmail(data: DocumentDeliveryData): string {
    return `
    <div style="font-family: 'Inter', sans-serif; padding: 40px; color: #1f2937;">
      <h1 style="color: #4f46e5; margin-bottom: 24px;">Your Updated Travel Documents</h1>
      ...
      <a href="${data.viewBookingUrl}" style="display: inline-block; padding: 12px 24px; background: #4f46e5; color: white; text-decoration: none; border-radius: 6px; font-weight: 600; margin: 16px 0;">View Your Booking</a>
      <p style="margin-top: 32px; font-size: 14px; color: #6b7280;">If you have any questions, our support team is available 24/7 to assist you.</p>
      <p style="margin-top: 8px; font-size: 14px; color: #6b7280;">Best regards,<br/>The TripAlfa Team</p>
    </div>
  `;
}
 ...
 */
export function generateDocumentDeliveryText(data: DocumentDeliveryData): string {
    return `

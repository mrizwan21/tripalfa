  ...
  return (
    <div className="w-full bg-white border-b py-6 mb-8 shadow-sm relative z-10">
      <div className="container mx-auto px-4 overflow-x-auto no-scrollbar">
        <div className="flex items-center justify-between min-w-[600px] max-w-6xl mx-auto relative pt-8 pb-4 gap-2">
          ...
          {STEPS.map((step, index) => {
            ...
            return (
              <React.Fragment key={step.id}>
                <div className="relative z-10 flex flex-col items-center flex-1 group cursor-default gap-4">
                  <div
                    className={`
                                            ...
                                            ${
                                              isActive
                                                ? "bg-[hsl(var(--secondary))] border-[hsl(var(--secondary))] text-[hsl(var(--secondary-foreground))] scale-110 shadow-lg ring-4 ring-yellow-50"
                                                : isCompleted
                                                  ? "bg-[hsl(var(--secondary))] border-[hsl(var(--secondary))] text-[hsl(var(--secondary-foreground))]"
                  ...
                  {isActive && (
                    <div className="absolute -bottom-6 flex flex-col items-center gap-4">
                      <div className="w-1.5 h-1.5 bg-[hsl(var(--secondary))] rounded-full animate-bounce" />
                    </div>
                  )}
                </div>
                {index < STEPS.length - 1 && (
                  ...
                  <div
                    className={`absolute h-[2px] transition-all duration-1000 top-1/2 -translate-y-1/2 z-0
                                        ${isCompleted ? "bg-[hsl(var(--secondary))]" : "bg-transparent"}`}
                    style={{

...
export const HOTEL_AMENITIES = [
  ...
  { code: 'CONCIERGE', name: 'Concierge', category: 'Service', is_popular: false },
  { code: 'LAUNDRY', name: 'Laundry Service', category: 'Service', is_popular: false },
  { code: 'SHUTTLE', name: 'Airport Shuttle', category: 'Transport', is_popular: false },
  ...
  { code: 'BEACH_ACCESS', name: 'Beach Access', category: 'Recreation', is_popular: false },
];
...
export const BOARD_TYPES = [
  ...
  { code: 'UAI', name: 'Ultra All Inclusive', description: 'Premium all-inclusive with branded drinks and extras' },
];
...
export const HOTEL_TYPES = [
  ...
  { code: 'BOUTIQUE', name: 'Boutique Hotel', description: 'Small stylish hotel' },
  { code: 'B&B', name: 'Bed & Breakfast', description: 'Small lodging with breakfast' },
  { code: 'GUESTHOUSE', name: 'Guesthouse', description: 'Private home offering lodging' },
];
...
export const POPULAR_DESTINATIONS = [
  { id: '1', name: 'Dubai', countryName: 'United Arab Emirates', countryCode: 'AE', hotelCount: 850 },
  { id: '2', name: 'Abu Dhabi', countryName: 'United Arab Emirates', countryCode: 'AE', hotelCount: 420 },
  { id: '3', name: 'Riyadh', countryName: 'Saudi Arabia', countryCode: 'SA', hotelCount: 580 },
  { id: '4', name: 'Jeddah', countryName: 'Saudi Arabia', countryCode: 'SA', hotelCount: 340 },
  { id: '5', name: 'Doha', countryName: 'Qatar', countryCode: 'QA', hotelCount: 290 },
  { id: '6', name: 'London', countryName: 'United Kingdom', countryCode: 'GB', hotelCount: 1200 },
  { id: '7', name: 'Paris', countryName: 'France', countryCode: 'FR', hotelCount: 950 },
  { id: '8', name: 'New York', countryName: 'United States', countryCode: 'US', hotelCount: 780 },
  { id: '9', name: 'Singapore', countryName: 'Singapore', countryCode: 'SG', hotelCount: 420 },
  { id: '10', name: 'Tokyo', countryName: 'Japan', countryCode: 'JP', hotelCount: 650 },
];

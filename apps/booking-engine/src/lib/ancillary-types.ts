...
export function calculateAncillarySummary(
  ...
  const specialServicesAmount = selections.specialServices.reduce(
    (sum, s) => sum + s.price,
    0,
  );
...
export const DEFAULT_SSR_OPTIONS: SpecialServiceOption[] = [
  {
    ...
    description:
      "Passenger can walk short distance but needs wheelchair for longer distances",
    price: 0,
    currency: "INR",
    requiresNotes: true,
  },
  {
    ...
    description:
      "Passenger completely immobile and needs wheelchair to/from aircraft seat",
    price: 0,
    currency: "INR",
    requiresNotes: true,
  },
  {
    ...
    description: "Passenger can walk but cannot climb stairs",
    price: 0,
    currency: "INR",
    requiresNotes: true,
  },
  ...
  },
  {
    ...
    code: "DEAF",
    name: "Deaf Passenger",
    description: "Assistance for hearing impaired passengers",
    price: 0,
    currency: "INR",
    requiresNotes: true,
  },
  {
    id: "BSCT",
    code: "BSCT",
    name: "Bassinet / Baby Cot",
    description:
      "Infant cot request for babies under 2 years (subject to availability)",
    price: 0,
    currency: "INR",
    requiresNotes: true,
  },
  {
    ...
    description: "Special assistance for children traveling alone",
    price: 0,
    currency: "INR",
    requiresNotes: true,
  },
  {
    ...
    description: "Airport staff assistance through the airport",
    price: 0,
    currency: "INR",
    requiresNotes: true,
  },
...
export const DEFAULT_FSC_MEALS: MealOption[] = [
  {
    ...
    description:
      "Spicy vegetarian meal prepared in Asian style, no meat or eggs",
    type: "vegetarian",
    price: 0,
    currency: "INR",
    category: "special",
  ...
  },
  {
    ...
    description: "Strict vegetarian meal containing no animal products",
    type: "vegan",
    price: 0,
    currency: "INR",
    category: "special",
  ...
  },
  {
    ...
    code: "MOML",
    name: "Muslim Meal",
    description: "Prepared according to Islamic dietary laws (Halal)",
    type: "special",
    price: 0,
    currency: "INR",
    category: "special",
  ...
  },
  {
    ...
    description: "Meal without wheat, rye, barley, or oats",
    type: "special",
    price: 0,
    currency: "INR",
    category: "special",
  ...
  },
  {
    ...
    name: "Hindu Meal",
    description:
      "Non-vegetarian meal prepared according to Hindu customs, no beef",
    type: "non-vegetarian",
    price: 0,
    currency: "INR",
    category: "special",
  ...
  },
  {
    ...
    code: "CHML",
    name: "Child Meal",
    description: "Meal designed for children (2-12 years)",
    type: "special",
    price: 0,
    currency: "INR",
    category: "special",
...
export const DEFAULT_LCC_MEALS: MealOption[] = [
  ...
  },
  {
    ...
    code: "SNK1",
    name: "Sandwich Combo",
    description: "Fresh sandwich with chips and a soft drink",
    type: "vegetarian",
    price: 250,
    currency: "INR",
    category: "standard",
  },
  {
    ...
    code: "SNK2",
    name: "Pasta & Salad",
    description: "Creamy pasta with fresh garden salad",
    type: "vegetarian",
    price: 300,
    currency: "INR",
    category: "standard",
  ...
  },
  {
    ...
    code: "BRK1",
    name: "Breakfast Box",
    description: "Omelette, hash browns, toast and coffee",
    type: "non-vegetarian",
    price: 280,
    currency: "INR",
    category: "standard",
  },
  {
    ...
    description: "Grilled steak with roasted potatoes and wine",
    type: "non-vegetarian",
    price: 750,
    currency: "INR",
    category: "premium",
...
export const DEFAULT_BAGGAGE_OPTIONS: BaggageOption[] = [
  {
    ...
    price: 1500,
    currency: "INR",
    description: "15kg Checked Baggage",
  },
  {
    id: "bag20",
    type: "checked",
  ...
  },
  {
    ...
    price: 3500,
    currency: "INR",
    description: "30kg Checked Baggage",
  },
  {
    id: "bag40",
    type: "checked",
    ...
    price: 5000,
    currency: "INR",
    description: "40kg Checked Baggage",
  },
];
...
export function formatPassengersFromBooking(
...
export function formatFlightSegments(segments: any[]): FlightSegmentInfo[] {
  return (segments || []).map((seg, idx) => ({
    ...
    flightNumber:
      seg.flightNumber ||
      (seg.carrierCode || seg.airline?.slice(0, 2).toUpperCase() || "XX") +

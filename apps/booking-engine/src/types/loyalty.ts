import type { LoyaltyTierRecord as LoyaltyTier, CustomerLoyaltyRecord as CustomerLoyalty } from '@tripalfa/shared-types';

// Customer-facing loyalty types
export type { LoyaltyTier, CustomerLoyalty };

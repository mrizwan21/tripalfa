        ...
        <div className="bg-[hsl(var(--primary))] sticky top-0 z-40">
          <div className="container mx-auto px-4 py-3 max-w-7xl flex items-center divide-x divide-white/10 gap-2">
            <Button
              ...
              size="md"
              onClick={() => navigate(-1)}
              className="pr-6 text-[hsl(var(--primary-foreground))] hover:text-[hsl(var(--secondary))] transition-colors"
            >
              <ArrowLeft size={24} />
            </Button>
            ...
            {(flight.segments || []).map((seg: FlightSegment, i: number) => (
              <div key={i} className="px-8 flex items-center gap-6">
                <div className="flex items-center gap-3">
                  <div className="text-center">
                    <p className="text-lg font-black text-[hsl(var(--primary-foreground))]">
                      {seg.origin}
                    </p>
                    <p className="text-[10px] text-[hsl(var(--primary-foreground))/0.7] font-bold">
                      {seg.originCity}
                    </p>
                  </div>
                  <div className="w-8 h-8 rounded-full bg-[hsl(var(--secondary))] flex items-center justify-center gap-2">
                    <Plane size={14} className="text-[hsl(var(--primary))]" />
                  </div>
                  <div className="text-center">
                    <p className="text-lg font-black text-[hsl(var(--primary-foreground))]">
                      {seg.destination}
                ...
                <div className="h-10 w-px bg-muted/10 mx-2" />
                <div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 space-y-10">
              <Button
                ...
                size="md"
                onClick={() => navigate(-1)}
                className="flex items-center gap-2 text-[hsl(var(--primary))] font-black text-xs uppercase tracking-widest mb-4 hover:translate-x-1 transition-transform"
              >
                ...
                <div className="p-10 space-y-8">
                  <div className="flex items-center justify-between bg-muted/50 p-6 rounded-3xl border border-border gap-2">
                    ...
                    <div className="flex items-center gap-4">
                      <span className="bg-[hsl(var(--secondary))] text-[hsl(var(--primary))] text-[10px] font-black px-4 py-1.5 rounded-lg uppercase tracking-widest">
                        Recommended!
                      </span>
                      <BadgeCheck size={32} className="text-muted-foreground" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-x-12 gap-y-4">
                    ...
                    <Button
                      variant="ghost"
                      size="md"
                      className="text-[hsl(var(--primary))] text-sm font-black mt-2 underline pl-7 px-4 py-2 text-sm font-medium rounded-md transition-colors hover:bg-muted"
                    >
                      ... and more
                    </Button>
                  </div>
                  ...
                  <div className="bg-purple-50/50 rounded-2xl p-6 border border-purple-100 flex items-center justify-between gap-2">
                    <div className="space-y-2">
                      ...
                      <p className="text-[10px] font-bold text-muted-foreground">
                        Based on over 20,000 Independent customer reviews
                      </p>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="flex justify-between items-center text-[10px] text-muted-foreground font-bold gap-4">
                  ...
                  <div className="space-y-3">
                    {selectedAddons.length > 0 ? (
                      ...
                      <p className="text-[11px] font-bold text-muted-foreground/60 italic">
                        No protection add-ons selected
                      </p>
                    )}
                ...
                <div className="bg-[hsl(var(--secondary))] rounded-[2rem] p-8 -mx-4 shadow-xl shadow-yellow-100">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center gap-4">
                      ...
                      <span className="text-sm font-black text-[hsl(var(--secondary-foreground))]">
                    ...
                    <div className="h-px bg-[hsl(var(--secondary-foreground)/0.15)] my-2" />
                    <div className="flex justify-between items-center gap-4">
                      <span className="text-lg font-black text-[hsl(var(--secondary-foreground))]">
                        Total :
                      </span>
                      <span className="text-xl font-black text-[hsl(var(--secondary-foreground))]">
              ...
              <div className="bg-card rounded-[2rem] border border-border shadow-lg p-8">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    className="bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] px-3 h-12 rounded-xl text-[7px] font-black uppercase tracking-widest whitespace-nowrap"
                  >
                    Apply coupon
                  </Button>
                </div>
              ...
              <div className="bg-card rounded-[2rem] border border-border shadow-lg p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    {loyaltyDropdownOpen && (
                      <div className="absolute z-20 mt-2 w-full bg-card rounded-xl border border-border shadow-xl max-h-64 overflow-y-auto">
                          ...
                          loyaltyPrograms.map((program) => (
                            ...
                            >
                              ...
                              <div className="text-xs text-muted-foreground">
                                {program.airlineName} ({program.airlineCode})
                              </div>
                            </Button>
                          ))
                        )}
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] px-8 h-12 rounded-xl text-[10px] font-black uppercase tracking-widest"
                    >
                      Submit
                    </Button>
                  </div>

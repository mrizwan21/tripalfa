    ...
    <TripLogerLayout>
      ...
      >
        ...
        <div className="bg-[hsl(var(--primary))] pt-32 pb-48 relative overflow-hidden">
          <div className="absolute inset-0 bg-[hsl(var(--primary)/0.1)]" />
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="card-description">Customize your journey</p>
                        </div>
                      </div>
                      {isTicketed && (
                    ...
                    <div className="card-header border-b border-border/50">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="card-description">Stay Information</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <>
                    <div className="card-header border-b border-border/50">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h2 className="card-title">Flight Segments</h2>
                          <p className="card-description">Journey Details</p>
                        </div>
                      </div>
                    </div>
                    <div className="card-content pt-6 space-y-4">
                      {flight.segments?.map((seg: any, i: number) => (
                        <div key={i} className="bg-muted rounded-xl p-8 relative overflow-hidden">
                          <div className="absolute top-0 right-0 w-32 h-full bg-background/50" />
                          <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
                            <div className="flex items-center gap-4 min-w-[150px]">
                              ...
                              <div>
                                <h3 className="font-semibold text-foreground">{seg.carrier}</h3>
              ...
              <div className="card shadow-md sticky top-32">
                ...
                <div className="card-content pt-6 space-y-4">
                  <div className="flex justify-between items-center text-sm gap-4">
                    ...
                    <span className="font-medium text-foreground">{formatCurrency(3220)}</span>
                  </div>
                  <div className="flex justify-between items-center text-sm gap-4">
                    <span className="text-muted-foreground">Taxes & Fees</span>
                    <span className="font-medium text-foreground">{formatCurrency(240)}</span>
                  </div>
        ...
        {cancellationInfo && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm">
            <div className="bg-card w-full max-w-md rounded-xl border border-border shadow-2xl p-8 animate-in fade-in zoom-in duration-300">
              <div className="flex flex-col items-center text-center gap-6">
                ...
                <div className="w-full bg-muted/50 rounded-xl p-6 space-y-3">

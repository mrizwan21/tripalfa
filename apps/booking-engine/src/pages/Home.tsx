...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 gap-0">
      {/* Floating Cart */}
      <div className="fixed top-4 right-4 z-50">
        ...
        >
          <BrandIcon icon={ShoppingCart} size={22} className="text-gray-700 group-hover:text-[#F45D48]" />
          {cartCount > 0 && (
            <span className="absolute -top-1 -right-1 bg-gradient-to-r from-[#F45D48] to-[#E8453A] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold shadow-md">
              {cartCount}
            </span>
          )}
        </button>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-[#F45D48] to-[#E8453A] rounded-xl flex items-center justify-center shadow-lg shadow-[#F45D48]/30">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a
                href="#flights"
                className={cn(
                  "text-sm font-medium transition-colors hover:text-[#F45D48]",
            ...
            <div className="flex items-center gap-4">
              <button className="hidden md:flex items-center gap-2 px-4 py-2.5 bg-white/90 backdrop-blur-sm rounded-xl border border-white/20 text-sm font-medium text-gray-700 hover:bg-white hover:shadow-md transition-all duration-300">
                <BrandIcon icon={Sparkle} size={16} className="text-[#F45D48]" />
      ...
      <div className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460]">
          ...
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-20 left-10 w-72 h-72 bg-[#F45D48]/20 rounded-full blur-3xl" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-2 mb-6 shadow-lg">
                <BrandIcon icon={Sparkle} size={14} weight="fill" className="text-[#F45D48]" />
                ...
                {tabItems.map(({ id, label, icon: Icon }) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={isDisabled}
                      className={cn(
                        "flex-1 flex items-center justify-center gap-2.5 py-3.5 px-4 rounded-2xl text-sm font-medium transition-all duration-300",
                    ...
                    >
                      <Icon
                        ...
                        className={activeTab === id ? "text-[#F45D48]" : ""}
                      />
              ...
              <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
                    <div className="lg:col-span-1 relative group">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-11 h-14 rounded-xl border-gray-200 bg-gray-50 focus:border-[#F45D48] focus:ring-[#F45D48]/20 transition-all duration-200"
                          value={searchQuery}
                        ...
                        {airports.length > 0 && (
                          <div className="absolute top-full mt-2 w-full bg-white rounded-xl shadow-xl shadow-black/10 border border-gray-100 z-20 max-h-60 overflow-y-auto">
                            {airports.map((airport, index) => (
                              ...
                              >
                                <div className="w-9 h-9 rounded-lg bg-[#F45D48]/10 flex items-center justify-center shrink-0">
                                  <BrandIcon icon={Plane} size={16} className="text-[#F45D48]" />
                                </div>
                                <div className="min-w-0 flex-1">
                                  <p className="font-medium text-sm text-gray-900 truncate">{airport.title}</p>
                                  <p className="text-xs text-gray-400 truncate">{airport.subtitle}</p>
                                </div>
                                <span className="px-2 py-0.5 rounded bg-[#F45D48]/10 text-[#F45D48] text-xs font-bold font-mono">
                                  {airport.code}
                                </span>
                              </button>
                            ))}
                    ...
                    <div className="lg:col-span-1">
                      <button
                        ...
                        className="w-full h-14 rounded-xl bg-gradient-to-r from-[#F45D48] to-[#E8453A] text-white font-semibold text-sm flex items-center justify-center gap-2 shadow-lg shadow-[#F45D48]/30 hover:shadow-xl hover:shadow-[#F45D48]/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none"
                      >
                        <BrandIcon icon={MagnifyingGlass} size={20} weight="duotone" className="text-white" />
                ...
                {activeTab === "packages" && (
                  <div className="text-center py-10">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#F45D48]/10 to-[#F45D48]/5 flex items-center justify-center mx-auto mb-4">
                      <BrandIcon icon={SuitcaseSimple} size={32} className="text-[#F45D48]" />
                    </div>
                    ...
                    <button className="h-12 px-8 rounded-xl bg-gradient-to-r from-[#F45D48] to-[#E8453A] text-white font-semibold shadow-lg shadow-[#F45D48]/30 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
                ...
                {activeTab === "cars" && (
                  <div className="text-center py-10">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/10 to-blue-500/5 flex items-center justify-center mx-auto mb-4">
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <BrandIcon icon={Compass} size={20} className="text-[#F45D48]" />
                <span className="text-sm font-semibold text-[#F45D48] uppercase tracking-wider">
                  Explore
                </span>
              </div>
            ...
            <button className="hidden md:flex items-center gap-2 text-[#F45D48] font-semibold hover:gap-3 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {(popularDestinations.length > 0
              ...
              return (
                <div
                  key={dest.city || idx}
                  className="group relative rounded-2xl overflow-hidden aspect-[3/4] cursor-pointer shadow-md hover:shadow-2xl transition-all duration-500"
                >
                  <img
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-10">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <BrandIcon icon={Plane} size={20} className="text-[#F45D48]" />
                <span className="text-sm font-semibold text-[#F45D48] uppercase tracking-wider">
                  Featured
                </span>
              </div>
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="text-right">
                      <p className="text-2xl font-bold text-[#F45D48]">
                    ...
                    <div className="flex-1 px-6 text-center">
                      ...
                      <div className="w-full h-px bg-gray-200 relative">
                        <div className="absolute left-1/2 -translate-x-1/2 -top-1.5 bg-gray-50 px-1.5">
                          <BrandIcon icon={Plane} size={14} weight="fill" className="text-[#F45D48]" />
                        </div>
                      </div>
                  ...
                  <button className="w-full mt-6 py-3 rounded-xl border border-gray-200 text-gray-700 font-medium text-sm hover:border-[#F45D48]/30 hover:text-[#F45D48] hover:bg-[#F45D48]/5 transition-all duration-300">
      ...
      <section className="py-20 bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-20 w-64 h-64 bg-[#F45D48]/30 rounded-full blur-3xl" />
          <div className="absolute bottom-10 right-20 w-80 h-80 bg-blue-500/20 rounded-full blur-3xl" />
        </div>
        <div className="container mx-auto px-4 relative z-10 text-center">
          <BrandIcon icon={GlobeHemisphereWest} size={48} weight="duotone" className="text-white/60 mx-auto mb-6" />
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Discover Your Next Adventure
          </h2>
          <p className="text-white/60 max-w-xl mx-auto mb-8">
            Join millions of travelers who trust TripAlfa for their journeys. Book flights, hotels, and more with confidence.
          </p>
          <div className="flex items-center justify-center gap-4">
            <button className="px-8 py-4 rounded-xl bg-gradient-to-r from-[#F45D48] to-[#E8453A] text-white font-semibold shadow-lg shadow-[#F45D48]/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              Start Searching
            </button>

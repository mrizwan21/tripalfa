...
const HEADER_PRIMARY_ACTION_CLASS =
  'h-14 px-10 rounded-xl text-foreground font-black text-[10px] uppercase tracking-widest hover:scale-105 transition-all flex items-center gap-3 group';
const HEADER_SECONDARY_ACTION_CLASS =
  'h-14 px-10 rounded-xl bg-primary-foreground/5 border border-primary-foreground/10 text-primary-foreground font-black text-[10px] uppercase tracking-widest hover:bg-primary-foreground/10 transition-all flex items-center gap-3';
      ...
      >
        ...
        >
          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10 text-center space-y-10">
            <div className="relative inline-block">
              <div className="w-28 h-28 rounded-xl bg-secondary mx-auto flex items-center justify-center text-foreground shadow-[0_20px_50px_rgba(255,215,0,0.3)] animate-bounce-subtle gap-2">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="px-8 py-3 rounded-xl bg-background/5 border border-border/10 backdrop-blur-md">
                  <span
            ...
            <div className="flex items-center justify-center gap-6 pt-4 flex-wrap">
              {isHold ? (
                ...
                >
                  <Wallet size={18} className="group-hover:translate-y-0.5 transition-transform" />{' '}
        ...
        <div className="container mx-auto px-4 max-w-7xl -mt-24 relative z-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-12">
              ...
              <div className="bg-background rounded-xl p-12 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.05)] border border-border relative group overflow-hidden">
                ...
                <div className="relative z-10 space-y-10">
                  <div className="flex items-center gap-8">
                    <div className="w-20 h-20 rounded-xl bg-purple-50 flex items-center justify-center text-foreground shadow-inner gap-2">
                      <Sparkles size={40} />
                    </div>
                  ...
                  <p className="text-[12px] font-bold text-muted-foreground leading-relaxed max-w-2xl bg-muted p-6 rounded-xl italic border-l-4 border-muted-foreground">
                    {isHold
              ...
              <div className="bg-background rounded-xl p-12 shadow-sm border border-border space-y-12">
                ...
                <div className="space-y-12">
                  {isHotel && hotelSummary ? (
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12 bg-muted/50 rounded-xl p-12 group hover:bg-background hover:shadow-2xl transition-all duration-700 border-2 border-transparent hover:border-border">
                      <div className="flex items-center gap-8">
                        <div className="w-16 h-16 bg-background rounded-xl flex items-center justify-center shadow-xl group-hover:rotate-12 transition-transform duration-500 gap-2">
              ...
              (isHotel && crossSellFlights.length > 0) ? (
                <div className="bg-foreground rounded-xl p-12 shadow-2xl space-y-8 text-background relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 rounded-xl bg-background/20 flex items-center justify-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      {!isHotel &&
                        crossSellHotels.map((hotel, i) => (
                          <div
                            key={hotel.id}
                            className="bg-background/10 backdrop-blur-sm rounded-xl p-6 hover:bg-background/20 transition-all cursor-pointer group"
                          >
                            ...
                            <div className="flex items-end justify-between">
                              <div>
                                <p className="text-[10px] text-background/60">From</p>
                                <p className="text-xl font-black text-secondary">${hotel.price}</p>
                              </div>
                              <Button size="sm" className={CROSS_SELL_ACTION_CLASS}>
                                View
                              </Button>
                            </div>
                          </div>
                        ...
                        crossSellFlights.map((flightOffer, i) => (
                          ...
                          >
                            <div className="flex items-center gap-4 mb-4">
                              <div className="w-12 h-12 rounded-xl bg-background/20 flex items-center justify-center text-lg font-black gap-2">
            ...
            <div className="lg:col-span-4 space-y-12">
              <div className="bg-background rounded-xl p-10 border border-border shadow-sm space-y-8">
                <div className="space-y-2">
                ...
                <Button
                  variant="outline"
                  className="w-full h-14 rounded-xl border-2 border-border hover:border-muted-foreground hover:text-foreground text-[10px] font-black uppercase tracking-widest transition-all"
                >
                  View All Stays
                </Button>
              </div>

              <div className="bg-[hsl(var(--primary))] rounded-xl p-10 shadow-2xl space-y-8 text-[hsl(var(--primary-foreground))] relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-40 h-40 bg-foreground/20 rounded-full blur-[60px]" />
                <div className="relative z-10 space-y-6">
                  <div className="w-12 h-12 rounded-xl bg-background/5 border border-border/10 flex items-center justify-center text-secondary gap-2">
                    <Bell size={24} />
                  </div>
                  <div className="space-y-2">
        ...
        {showPaymentModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 gap-2">
            ...
            />
            <div className="relative bg-background w-full max-w-md rounded-xl shadow-2xl p-10 animate-in zoom-in-95 duration-300">
              <Button
                variant="ghost"
                onClick={() => setShowPaymentModal(false)}
              ...
              <div className="text-center space-y-6">
                <div className="w-20 h-20 rounded-xl bg-amber-50 flex items-center justify-center mx-auto gap-2">
                ...
                <div className="space-y-3">
                  {canPayWithCard && (
                    <Button
                      ...
                      className="w-full h-14 rounded-xl text-primary-foreground font-black text-[10px] uppercase tracking-widest transition-colors flex items-center justify-center gap-3"
                    >
                  ...
                  {canPayWithWallet && (
                    <Button
                      ...
                      className="w-full h-14 rounded-xl bg-foreground text-background font-black text-[10px] uppercase tracking-widest hover:bg-foreground/90 transition-colors flex items-center justify-center gap-3"
                    >

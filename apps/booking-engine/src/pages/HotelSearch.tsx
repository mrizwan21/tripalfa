    ...
    return (
      <TripLogerLayout>
        <div className="bg-[hsl(var(--background))] min-h-screen pt-28 flex items-center justify-center px-4 gap-2">
          <Card className="w-full max-w-xl p-10 text-center rounded-xl border border-border shadow-sm space-y-4">
      ...
      <div className="bg-[hsl(var(--background))] min-h-screen pt-28">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 max-w-6xl relative z-10 py-16">
            ...
            {/* Premium Search Card */}
            <Card className="p-0 bg-background/95 backdrop-blur-2xl shadow-[0_30px_60px_-20px_rgba(0,0,0,0.4)] border border-border/50 rounded-xl overflow-visible relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="w-full h-14 pl-12 pr-4 bg-muted border-2 border-transparent rounded-xl text-sm font-bold text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-[hsl(var(--primary))] focus:bg-background hover:bg-background transition-all"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="w-full h-14 pl-12 pr-4 bg-muted border-2 border-transparent rounded-xl text-sm font-bold text-foreground focus:outline-none focus:border-[hsl(var(--primary))] focus:bg-background hover:bg-background cursor-pointer transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <select
                        ...
                        className="w-full h-14 pl-12 pr-4 bg-muted border-2 border-transparent rounded-xl text-sm font-bold text-foreground focus:outline-none focus:border-[hsl(var(--primary))] focus:bg-background hover:bg-background cursor-pointer transition-all appearance-none"
                      >
                        {[1, 2, 3, 4, 5, 6].map(n => (
                  ...
                  <div className="flex items-end gap-4">
                    <Button
                      ...
                      disabled={isLoading}
                      className="w-full h-14 bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary)/0.9)] font-black rounded-xl shadow-xl shadow-indigo-200 uppercase text-[10px] tracking-[0.2em] transition-all hover:scale-105 active:scale-95 disabled:opacity-50"
                    >
                      {isLoading ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                {(popularDestinations.data || []).slice(0, 5).map((dest: any, i: number) => (
                  <div
                    ...
                    className="group relative h-64 rounded-xl overflow-hidden cursor-pointer shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500"
                  >
                    <img

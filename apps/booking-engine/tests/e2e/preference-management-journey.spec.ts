...
test.describe("Preference Management Journey E2E", () => {
  test("Customer sets email-only notification preferences", async ({
    page,
  }) => {
    ...
    await expect(
      page.locator("text=Preferences saved successfully"),
    ).toBeVisible();
  ...
  test("Customer disables all optional notifications", async ({ page }) => {
    ...
    await expect(
      page.locator("text=Email notification sent"),
    ).not.toBeVisible();
    await expect(page.locator("text=SMS notification sent")).not.toBeVisible();
    await expect(page.locator("text=Push notification sent")).not.toBeVisible();
  ...
  test("Category-specific notification preferences", async ({ page }) => {
    ...
    await expect(
      page.locator("text=Booking: Email notification sent"),
    ).toBeVisible();
    await expect(
      page.locator("text=Booking: SMS notification sent"),
    ).toBeVisible();
    ...
    await expect(
      page.locator("text=Payment: Email notification sent"),
    ).not.toBeVisible();
    await expect(
      page.locator("text=Payment: SMS notification sent"),
    ).not.toBeVisible();
    ...
    await expect(
      page.locator("text=Reminder: Email notification sent"),
    ).toBeVisible();
    await expect(
      page.locator("text=Reminder: SMS notification sent"),
    ).not.toBeVisible();
  });
  ...
  test("Preference inheritance for guest bookings", async ({ page }) => {
    ...
    await expect(
      page.locator("text=Guest booking: Email notification sent"),
    ).toBeVisible();
    await expect(
      page.locator("text=Guest booking: SMS notification sent"),
    ).not.toBeVisible();
  });
});

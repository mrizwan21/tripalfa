...
test.describe("Payment, Wallet & Finance Notification Integration Tests", () => {
  ...
  test.describe("Payment Finalization Flow Tests", () => {
    test("Complete payment finalization flow with multi-channel notifications", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Payment received notification sent"),
      ).toBeVisible();
      ...
      await expect(
        page.locator("text=Booking confirmed notification sent"),
      ).toBeVisible();
      ...
      await expect(
        page.locator("text=Booking status: confirmed"),
      ).toBeVisible();
      ...
      await expect(
        notifications.filter({ hasText: "Payment of $1500.00 USD received" }),
      ).toBeVisible();
      await expect(
        notifications.filter({ hasText: "Booking BK123456 confirmed" }),
      ).toBeVisible();

      // Step 9: Verify high priority notifications include SMS
      await expect(
        page.locator("text=High priority: SMS included"),
      ).toBeVisible();

      // Step 10: Verify metrics tracked
      await expect(
        page.locator("text=Notification metrics updated"),
      ).toBeVisible();
    });

    test("Payment finalization with wallet balance payment", async ({
      page,
    }) => {
      const login = new LoginPage(page);
      const checkout = new BookingCheckoutPage(page);
      ...
      await expect(
        page.locator("text=Wallet debit notification sent"),
      ).toBeVisible();
      await expect(
        page.locator("text=Remaining balance: $200.00"),
      ).toBeVisible();
  ...
  test.describe("Payment Service Tests", () => {
    test("Successful payment triggers notification", async ({ page }) => {
      ...
      await expect(
        page.locator(
          "text=Payment of $1500.00 USD received for booking BK123456",
        ),
      ).toBeVisible();
    });

    test("Failed payment sends high-priority failure notification", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Payment failed notification sent"),
      ).toBeVisible();

      // Step 3: Verify high priority and SMS included
      await expect(
        page.locator("text=High priority notification"),
      ).toBeVisible();
      await expect(page.locator("text=SMS notification sent")).toBeVisible();
      ...
      await page.goto("/notifications");
      await expect(
        page.locator("text=Payment failed: insufficient_funds"),
      ).toBeVisible();
      await expect(
        page.locator("text=Please try again with a different payment method"),
      ).toBeVisible();
    });
    ...
    test("Refund processed triggers refund notification", async ({ page }) => {
      ...
      await expect(
        page.locator(
          "text=Refund of $1500.00 USD processed for booking BK123456",
        ),
      ).toBeVisible();
      await expect(
        page.locator("text=Reason: customer_cancellation"),
      ).toBeVisible();
    });

    test("Partial payment triggers partial payment notification", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Partial payment notification sent"),
      ).toBeVisible();

      // Step 3: Verify amounts in notification
      await page.goto("/notifications");
      await expect(
        page.locator("text=Partial payment of $750.00 USD received"),
      ).toBeVisible();
      await expect(
        page.locator("text=Remaining balance: $750.00 USD"),
      ).toBeVisible();
    });
    ...
    test("Urgent payment reminder sent when due date approaching", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Urgent payment reminder sent"),
      ).toBeVisible();
      await expect(page.locator("text=SMS notification sent")).toBeVisible();
  ...
  test.describe("Wallet Transaction Tests", () => {
    test("Wallet credit triggers balance update notification", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Wallet credit notification sent"),
      ).toBeVisible();

      // Step 3: Verify notification includes new balance
      await page.goto("/notifications");
      await expect(
        page.locator("text=Wallet credited $500.00 USD"),
      ).toBeVisible();
      await expect(
        page.locator("text=New balance: $1200.00 USD"),
      ).toBeVisible();
    });
    ...
    test("Wallet debit triggers transaction notification", async ({ page }) => {
      ...
      await page.goto("/notifications");
      await expect(
        page.locator("text=Wallet debited $200.00 USD for booking booking-456"),
      ).toBeVisible();
      await expect(
        page.locator("text=Remaining balance: $1000.00 USD"),
      ).toBeVisible();
    });
    ...
    test("Low balance triggers alert notification", async ({ page }) => {
      ...
      await page.goto("/notifications");
      await expect(
        page.locator("text=Wallet balance low: $50.00 USD"),
      ).toBeVisible();
      await expect(page.locator("text=Consider adding funds")).toBeVisible();
    });

    test("Wallet transfer triggers confirmation notification", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Wallet transfer notification sent"),
      ).toBeVisible();

      // Step 3: Verify transfer details
      await page.goto("/notifications");
      await expect(
        page.locator("text=Wallet transfer of $300.00 USD completed"),
      ).toBeVisible();
      await expect(
        page.locator("text=Remaining balance: $700.00 USD"),
      ).toBeVisible();
    });
    ...
    test("Transaction history notification sent", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Transaction history notification sent"),
      ).toBeVisible();

      // Step 4: Verify history details included
      await page.goto("/notifications");
      await expect(
        page.locator("text=Transaction history updated"),
      ).toBeVisible();
      await expect(page.locator("text=Recent transactions: 2")).toBeVisible();
    });

    test("Failed wallet transaction sends error notification", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Wallet transaction failed"),
      ).toBeVisible();
      ...
      await page.goto("/notifications");
      await expect(
        page.locator("text=Wallet transaction failed: insufficient_balance"),
      ).toBeVisible();
      await expect(
        page.locator("text=Please check your balance and try again"),
      ).toBeVisible();
    });
  });
  ...
  test.describe("Payment Gateway Webhook Tests", () => {
    test("Payment success webhook triggers notification", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Payment success webhook processed"),
      ).toBeVisible();
      ...
      await expect(
        page.locator("text=Webhook signature validated"),
      ).toBeVisible();
    });

    test("Payment failure webhook triggers failure notification", async ({
      page,
    }) => {
      ...
      // Step 2: Verify webhook processed
      await expect(
        page.locator("text=Payment failure webhook processed"),
      ).toBeVisible();
    ...
    test("Refund webhook triggers refund notification", async ({ page }) => {
      ...
      await page.goto("/notifications");
      await expect(
        page.locator("text=Refund of $1500.00 USD processed"),
      ).toBeVisible();
    });

    test("Chargeback webhook triggers chargeback notification", async ({
      page,
    }) => {
      ...
      // Step 2: Verify webhook processed
      await expect(
        page.locator("text=Chargeback webhook processed"),
      ).toBeVisible();

      // Step 3: Verify chargeback notification sent
      await expect(
        page.locator("text=Chargeback notification sent"),
      ).toBeVisible();

      // Step 4: Verify urgent priority
      await expect(
        page.locator("text=Urgent priority notification"),
      ).toBeVisible();
      await expect(page.locator("text=SMS notification sent")).toBeVisible();
      await expect(page.locator("text=Email notification sent")).toBeVisible();
    });
    ...
    test("Webhook signature validation", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Webhook signature validation failed"),
      ).toBeVisible();
    ...
    test("Idempotency prevents duplicate notifications", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Payment notification sent"),
      ).toBeVisible();
      ...
      await expect(
        page.locator("text=Duplicate webhook rejected"),
      ).toBeVisible();
      await expect(
        page.locator("text=No additional notification sent"),
      ).toBeVisible();
    });
    ...
    test("Webhook retry handling", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Webhook processing failed, retry scheduled"),
      ).toBeVisible();
  ...
  test.describe("Bank Notification Tests", () => {
    test("Bank transfer initiated triggers notification", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Bank transfer notification sent"),
      ).toBeVisible();

      // Step 3: Verify transfer details
      await page.goto("/notifications");
      await expect(
        page.locator("text=Bank transfer of $2500.00 USD initiated"),
      ).toBeVisible();
      await expect(page.locator("text=Chase Bank ****1234")).toBeVisible();
    });

    test("Bank transfer completed triggers confirmation notification", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Transfer confirmation notification sent"),
      ).toBeVisible();

      // Step 3: Verify confirmation details
      await page.goto("/notifications");
      await expect(
        page.locator("text=Bank transfer completed: $2500.00 USD"),
      ).toBeVisible();
      await expect(page.locator("text=Reference: REF123456")).toBeVisible();
    });

    test("Bank transfer failed triggers failure notification", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Transfer failure notification sent"),
      ).toBeVisible();

      // Step 3: Verify failure details and retry instructions
      await page.goto("/notifications");
      await expect(
        page.locator("text=Bank transfer failed: insufficient_funds"),
      ).toBeVisible();
      await expect(
        page.locator("text=Please check your account and try again"),
      ).toBeVisible();
    });

    test("Bank account verification triggers notification", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator("text=Account verification notification sent"),
      ).toBeVisible();

      // Step 3: Verify verification details
      await page.goto("/notifications");
      await expect(
        page.locator("text=Bank account ****1234 verified"),
      ).toBeVisible();
      await expect(
        page.locator("text=You can now use this account for transfers"),
      ).toBeVisible();
    });
    ...
    test("Wire transfer details notification sent", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Wire transfer details sent"),
      ).toBeVisible();

      // Step 4: Verify banking details included
      await page.goto("/notifications");
      await expect(
        page.locator("text=Wire transfer details for $5000.00 USD"),
      ).toBeVisible();
  ...
  test.describe("End-to-End Scenario Tests", () => {
    test("Scenario 1: Successful Payment Flow", async ({ page }) => {
      ...
      await page.evaluate(() => {
        window.dispatchEvent(
          new CustomEvent("mockPaymentGatewayProcessing", {
            detail: { bookingId: "BK123456", amount: 1500.0, currency: "USD" },
          }),
        );
      });
      ...
      await expect(
        page.locator("text=Payment finalization triggered"),
      ).toBeVisible();
      ...
      await page.goto("/notifications");
      await expect(
        page.locator("text=Payment of $1500.00 USD for booking BK123456"),
      ).toBeVisible();
      await expect(
        page.locator("text=Booking BK123456 confirmed"),
      ).toBeVisible();

      // Step 9: Verify notifications marked as sent
      await expect(
        page.locator("text=Notifications status: sent"),
      ).toBeVisible();

      // Step 10: Verify metrics tracked
      await expect(
        page.locator("text=Payment notification metrics updated"),
      ).toBeVisible();
    });
    ...
    test("Scenario 2: Failed Payment Flow", async ({ page }) => {
      ...
      await page.goto("/notifications");
      await expect(
        page.locator("text=Payment failed: card_declined"),
      ).toBeVisible();
    ...
    test("Scenario 3: Refund Processing", async ({ page }) => {
      ...
      await adminNotifications.initiateRefund(
        "BK123456",
        1500.0,
      ...
      await expect(
        page.locator("text=Refund will appear in 3-5 business days"),
      ).toBeVisible();
      ...
      await expect(
        page.locator("text=Wallet balance notification sent"),
      ).toBeVisible();
    });
    ...
    test("Scenario 4: Wallet Transaction Flow", async ({ page }) => {
      ...
      await page.goto("/notifications");
      await expect(
        page.locator("text=Wallet debited $200.00 USD"),
      ).toBeVisible();
      await expect(
        page.locator("text=Remaining balance: $1000.00 USD"),
      ).toBeVisible();
    ...
    test("Scenario 5: Payment Reminder Flow", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Payment reminder triggered"),
      ).toBeVisible();

      // Step 4: Verify reminder notification sent
      await expect(
        page.locator("text=Payment reminder notification sent"),
      ).toBeVisible();

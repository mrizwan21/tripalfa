...
test.describe('Flight Booking Flow', () => {
  ...
  test('FB-001: Complete flight booking with card payment (Happy Path)', async ({ page }) => {
    ...
    console.log('Flight results inner HTML preview:', innerContent.substring(0, 200));
  ...
  test('FB-002: Complete flight booking with wallet payment', async ({ page }) => {
  ...
  test('FB-003: Flight booking - Payment failure handling', async ({ page }) => {
  ...
  test('FB-005: Flight booking - Round trip with multiple passengers', async ({ page }) => {
    ...
    await passengerDetails.fillPassengerDetails('Jane', 'Doe', {

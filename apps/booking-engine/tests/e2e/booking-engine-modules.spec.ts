...
test.describe('Booking Engine - Module Tests', () => {
  ...
  test.describe('Layout Components', () => {
    test('should display main layout structure', async ({ page }) => {
      ...
      const mainContent = page.locator('main, [role="main"], .main-content, [class*="layout"]').first();
  ...
  test.describe('UI Design Tests', () => {
    ...
    test('should have smooth transitions or animations', async ({ page }) => {
      ...
      expect(hasAnimations || await page.locator('[class*="motion"], [class*="animate"]').count() > 0).toBeTruthy();
    });
  });
  ...
  test.describe('Performance Tests', () => {
    test('should load flights page within acceptable time', async ({ page }) => {

...
describe("Booking Engine - Notification System", () => {
  ...
  describe("Error Notification Flows", () => {
    it("should display error notification for booking failure", () => {
      ...
      expect(
        screen.getByText("Unable to complete your booking. Please try again."),
      ).toBeInTheDocument();
    });
    ...
    it("should display error notification for payment failure", () => {
      ...
      expect(
        screen.getByText("Your payment could not be processed."),
      ).toBeInTheDocument();
    });
    ...
    it("should display system error notification", () => {
      ...
      expect(
        screen.getByText("A system error occurred. Please contact support."),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Notification Display", () => {
    it("should display a success notification", () => {
      ...
      expect(
        screen.getByText("Your booking has been confirmed successfully"),
      ).toBeInTheDocument();
    });
    ...
    it("should display an error notification", () => {
      ...
      expect(screen.getByText("Booking Failed")).toBeInTheDocument();
      expect(
        screen.getByText("Unable to complete the booking. Please try again."),
      ).toBeInTheDocument();
    });
  ...
  describe("Notification Dismissal", () => {
    ...
    it("should persist notification without duration", () => {
      ...
      expect(
        screen.getByText("This notification should persist"),
      ).toBeInTheDocument();
    });
  });

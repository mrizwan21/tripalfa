...
router.get(
  ...
  async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      logger.info(
        `${SERVICE_NAME}: Getting transaction history for user ${userId}`,
      );
      ...
      res
        .status(500)
        .json({ success: false, error: "Failed to get transaction history" });
    }
  },
);
...
router.get(
  ...
  async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      logger.info(
        `${SERVICE_NAME}: Getting transaction summary for user ${userId}`,
      );
      ...
      res
        .status(500)
        .json({ success: false, error: "Failed to get transaction summary" });
    }
  },
);
...
router.get(
  ...
  async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      logger.info(
        `${SERVICE_NAME}: Exporting transactions for user ${userId} as ${exportFormat}`,
      );

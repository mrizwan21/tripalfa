...
describe('walletService', () => {
  ...
  describe('topup', () => {
    ...
    it('should be idempotent', async () => {
      ...
      const walletBalance = await walletService.getWalletBalance(userId1, 'USD');
  ...
  describe('refund', () => {
    it('should refund full amount', async () => {
      ...
      const balanceBeforeRefund = await walletService.getWalletBalance(userId1, 'USD');
      ...
      const balanceAfterRefund = await walletService.getWalletBalance(userId1, 'USD');

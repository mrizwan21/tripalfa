...
import { AncillaryServicesService } from '../services/ancillaryServicesService';
import logger from '../utils/logger';

export class AncillaryServicesController {
  private ancillaryServicesService: AncillaryServicesService;

  constructor() {
    this.ancillaryServicesService = new AncillaryServicesService();
  }

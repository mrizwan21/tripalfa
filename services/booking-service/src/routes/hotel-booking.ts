...
<head>
  ...
  <style>
    ...
    .hotel-info { background: #f9fafb; padding: 15px; border-radius: 8px; }
    .guest { background: #f9fafb; padding: 10px; margin: 5px 0; border-radius: 4px; }
...
<head>
  ...
  <style>
    ...
    .section { margin: 20px 0; padding: 15px; border: 1px solid #e5e7eb; border-radius: 8px; }
    .hotel-info { background: #f9fafb; padding: 15px; border-radius: 8px; text-align: center; }
    .guest-info { background: #f9fafb; padding: 15px; border-radius: 8px; }
    .detail-row { display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid #f3f4f6; }
    .qr-placeholder { width: 120px; height: 120px; background: #f3f4f6; margin: 20px auto; display: flex; align-items: center; justify-content: center; border-radius: 8px; }
  </style>
</head>
<body>
  <div class="header">
...
/**
 * POST /api/hotel-booking/payment
...
/**
 * POST /api/hotel-booking/voucher
 * Issue hotel voucher for confirmed booking (Step 4 of E2E flow)
 */
...
/**
 * POST /api/hotel-booking/cancel
 * Cancel hotel booking (Step 5 of E2E flow)
 */
...
/**
 * GET /api/hotel-booking/workflow/:workflowId
 * Get workflow state
 */
...
/**
 * GET /api/hotel-booking/workflows
...
/**
 * POST /api/hotel-booking/full-flow
 * Execute complete end-to-end hotel booking flow (for testing)
 */

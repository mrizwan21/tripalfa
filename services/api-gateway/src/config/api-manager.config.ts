...
export const DUFFEL_ENDPOINTS: EndpointConfig[] = [
  ...
  // Nearby Airports - Convenience endpoint
  {
    ...
    serviceId: "bookingService",
    description:
      "Find nearby airports - convenience endpoint using Duffel Places API",
    requiresAuth: false,
    rateLimit: { requestsPerMinute: 60, requestsPerHour: 2000 },
    timeout: 5000,
  },
  ...
  // Hotel Destinations Search (for Autocomplete)
  {
    ...
    serviceId: "bookingService",
    description:
      "Search hotel destinations via LiteAPI cities search (proxied)",
    requiresAuth: false,
    rateLimit: { requestsPerMinute: 60, requestsPerHour: 2000 },
    timeout: 5000,
  },
  // Booking Amend - Update guest information
  {
    ...
    serviceId: "bookingService",
    description:
      "Update guest information for an existing booking (holder details)",
    requiresAuth: true,
    rateLimit: { requestsPerMinute: 20, requestsPerHour: 500 },
    timeout: 10000,
  },
...
export const HOTEL_HYBRID_ENDPOINTS: EndpointConfig[] = [
  ...
  },
  {
    ...
    serviceId: "bookingService",
    description:
      "Search hotels (POST) - Hybrid (Static DB + Live Rates from LITEAPI)",
    requiresAuth: false,
    rateLimit: { requestsPerMinute: 30, requestsPerHour: 500 },
    timeout: 30000,
  },
  ...
  // Facilities/Amenities
  {
    ...
    serviceId: "bookingService",
    description:
      "Get hotel facilities/amenities - Hybrid (Static DB + LITEAPI fallback)",
    requiresAuth: false,
    rateLimit: { requestsPerMinute: 60, requestsPerHour: 2000 },
    timeout: 10000,
  },
  // Filter Options for UI
  {
    ...
    serviceId: "bookingService",
    description:
      "Get filter options for hotel search UI (star ratings, facilities, etc.)",
    requiresAuth: false,
    rateLimit: { requestsPerMinute: 60, requestsPerHour: 2000 },
    timeout: 5000,
  },

...
import { resolveEndpoint, checkAuth, rateLimit, forwardRequest } from './middleware/api-gateway.middleware.js'
...
const DEPRECATION_WARNING = 'This endpoint is deprecated and will be removed in a future version. Please migrate to the new API routes.';

// Legacy flight booking routes - forward to new endpoints with deprecation headers
app.all('/bookings/flight/*', 
  (req, res, next) => {

...
export const validateZod: (schema: z.ZodSchema) => RequestHandler = (schema: z.ZodSchema) => {
...
export const createMarkupRuleSchema = z.object({
  body: z.object({
    ...
    applicableTo: z.array(z.string()).min(1, 'At least one applicable target is required'),

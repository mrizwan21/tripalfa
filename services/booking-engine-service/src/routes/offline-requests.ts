    ...
    try {
        ...
        const updatedRequest = await prisma.offlineChangeRequest.update({
            ...
            data: {
                ...
                timeline: {
                    ...(offlineRequest.timeline as any),
                    staffPricedAt: new Date().toISOString(),
                    staffId,
                    staffNotes,
                },
                internalNotes: {
                    ...(offlineRequest.internalNotes as any),
                    staffNotes,
                },
            },
        });
        ...
        await prisma.offlineRequestAuditLog.create({
            data: {
                ...
                actorId: staffId,
                actorType: 'staff',
                oldValues: { status: offlineRequest.status },
                newValues: { status: 'pricing_submitted', staffPricing, priceDifference },
            },
        });

        // Create notification queue entry
        const timeline = offlineRequest.timeline as any;
        await prisma.offlineRequestNotificationQueue.create({
            data: {
                offlineRequestId: id,
                status: 'pending',
                notificationType: 'offline_request_priced',
                recipientIds: [timeline?.customerId || 'customer'],
                content: {
    ...
    try {
        ...
        const updateData: any = {
            ...
            timeline: {
                ...
                rejectedAt: approved ? null : new Date().toISOString(),
            },
        };
        ...
        await prisma.offlineRequestAuditLog.create({
            data: {
                ...
                actorType: 'customer',
                oldValues: { status: offlineRequest.status },
                newValues: { status: newStatus, approved },
            },
        });
    ...
    try {
        ...
        await prisma.offlineRequestAuditLog.create({
            data: {
                ...
                actorId: 'system',
                actorType: 'system',
                newValues: { paymentId, amount, method, transactionRef },
            },
        });
    ...
    try {
        ...
        await prisma.offlineRequestAuditLog.create({
            data: {
                ...
                actorId: 'system',
                actorType: 'system',
                newValues: { ticketNumbers, voucherNumbers, invoiceId },
            },
        });

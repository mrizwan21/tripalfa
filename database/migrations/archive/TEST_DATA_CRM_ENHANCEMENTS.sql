-- Test Data for CRM Enhancements
...
-- DELETE FROM crm_visitor_event WHERE id LIKE 'test_%';
-- DELETE FROM crm_visitor_page_view WHERE id LIKE 'test_%';
-- DELETE FROM crm_visitor_session WHERE id LIKE 'test_%';
-- DELETE FROM crm_lead_score WHERE id LIKE 'test_%';
-- DELETE FROM crm_contact WHERE id LIKE 'test_%';
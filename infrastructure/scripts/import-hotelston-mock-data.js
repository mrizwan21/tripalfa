...
async function importHotelChains() {
  ...
  for (const chain of MOCK_DATA.hotelChains) {
    try {
      ...
      console.error(`Error importing hotel chain ${chain.name}:`, error.message);
    }
  }
...
async function importHotelFacilities() {
  ...
  for (const facility of MOCK_DATA.hotelFacilities) {
    try {
      ...
      console.error(`Error importing hotel facility ${facility.name}:`, error.message);
    }
  }
...
async function importHotelTypes() {
  ...
  for (const type of MOCK_DATA.hotelTypes) {
    try {
      ...
      console.error(`Error importing hotel type ${type.name}:`, error.message);
    }
  }
...
async function importHotels() {
  ...
  for (const hotel of MOCK_DATA.hotels) {
    try {
      ...
      console.error(`Error importing hotel ${hotel.name}:`, error.message);
    }
  }

  ...
  for (const endpoint of ENDPOINTS_TO_TEST) {
    try {
      ...
      if (error.response) {
        ...
        console.log(`❌ FAILED - Request setup error: ${error.message}`);
      }
    }
 ...
 */
async function testSOAPActions() {
  console.log('='.repeat(60));
 ...
 */
async function testSOAPNamespaces() {
  console.log('='.repeat(60));
...
module.exports = { testWSDLAccess, testSOAPActions, testSOAPNamespaces, runAllTests };